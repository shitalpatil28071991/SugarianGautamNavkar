...
public partial class Sugar_Report_rptStockDetailrepotnew : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CryDetailReportstock.rpt"));
                rpt.SetDataSource(dt);

                CryDetailReportstock.ReportSource = rpt;
                rpt.DataDefinition.FormulaFields["pagehead"].Text = "\"Undelivered Stock Report From " + datefrom + " To " + dateto + "\"";
                ...
                CryDetailReportstock.RefreshReport();
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrypurcheswisedata where  doc_dateConverted between '" + from +
                  "' and '" + ToDt + "' and selfBal='Y' and PD_ID!=0", con);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrypurcheswisedata where  doc_dateConverted between '" + from +
                  "' and '" + ToDt + "' and selfBal='Y' and PD_ID!=0 and doc_no='"+pur_no+"'" , con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
            }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryDetailReportstock.ReportSource = null;

        CryDetailReportstock.Dispose();
