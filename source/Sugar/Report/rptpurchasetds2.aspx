<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptpurchasetds2.aspx.cs" Inherits="Sugar_Report_rptpurchasetds2" %>
...
<body>
   ...
   <div>
        ...
        <CR:CrystalReportViewer ID="Crypurchasetds" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
