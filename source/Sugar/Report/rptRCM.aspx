<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptRCM.aspx.cs" Inherits="Sugar_Report_rptRCM" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="CryRCM" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
