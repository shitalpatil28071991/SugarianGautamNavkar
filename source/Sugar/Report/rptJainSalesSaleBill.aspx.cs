...
public partial class Sugar_Report_rptJainSalesSaleBill : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            cryjainsalessalebill.ReportSource = rpt;
            ...
            cryjainsalessalebill.RefreshReport();
        }
        catch (Exception)
        {
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryjainsalessalebill.ReportSource = null;

        cryjainsalessalebill.Dispose();
