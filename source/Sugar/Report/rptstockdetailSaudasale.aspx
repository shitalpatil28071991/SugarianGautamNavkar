<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptstockdetailSaudasale.aspx.cs" Inherits="Sugar_Report_rptstockdetailSaudasale" Title="Retail Stock"%>
...
<body>
    ...
    <div>
            ...
            <CR:CrystalReportViewer ID="CryStockBook_DetailSelf" runat="server" AutoDataBind="true"
