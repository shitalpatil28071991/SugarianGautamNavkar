<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptCashNotReceiveReport.aspx.cs" Inherits="Sugar_Report_rptCashNotReceiveReport" %>
    ...
    <form id="form1" runat="server">
          <div id="printReady">
            ...
            <asp:TextBox runat="server" ID="txtEmail" Width="300px"></asp:TextBox>
              ...
              <CR:CrystalReportViewer ID="CryCashNotReceiveReport" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
