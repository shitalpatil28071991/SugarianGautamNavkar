<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTenderidwisesauda.aspx.cs" Inherits="Sugar_Report_rptTenderidwisesauda" %>
...
<body>
    <form id="form1" runat="server">
     <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="CryTenderidwisesauda" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
