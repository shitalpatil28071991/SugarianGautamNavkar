...
public partial class Sugar_Report_rptDOInfo : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
               ...
               // docno = Request.QueryString["doc_no"];              
                ...
                rprt1.Load(Server.MapPath("cryDoInfo.rpt"));
                rprt1.SetDataSource(dt);
                CryDoInfo.ReportSource = rprt1;
    ...
    {
        this.CryDoInfo.ReportSource = null;
