<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTransportpaidFreightRegister.aspx.cs" Inherits="Sugar_Report_rptTransportpaidFreightRegister" %>
...
<body>
    <form id="form1" runat="server">
     <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="CryTransportpaidFreightRegister" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
