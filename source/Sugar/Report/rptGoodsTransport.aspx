<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptGoodsTransport.aspx.cs" Inherits="Sugar_Report_rptGoodsTransport" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="CryGoodsTransport" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
