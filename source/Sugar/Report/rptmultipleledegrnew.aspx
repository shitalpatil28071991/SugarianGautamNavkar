<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptmultipleledegrnew.aspx.cs" Inherits="Sugar_Report_rptmultipleledegrnew" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryMultiplelegerfinal" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
