<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDateWiseSaleRegisterforMill.aspx.cs" Inherits="Sugar_Report_rptDateWiseSaleRegisterforMill" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="CryDateWiseSaleRegisterforMill" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
