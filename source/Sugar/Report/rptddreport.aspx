<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptddreport.aspx.cs" Inherits="Sugar_Report_rptddreport" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="Cryddreport" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
