<%@ Page Title="rpt:Datewise Dispatch Ledger" Language="C#" AutoEventWireup="true" CodeFile="rptDayWiseDispatchLedger.aspx.cs"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function sp(Tenderno, accode, Action) {
            var tn;
            window.open('../Inword/pgeSugarPurchaseForGSTxml.aspx?purchaseid=' + accode + '&tenderid=' + accode + '&Action=' + Action);    //R=Redirected  O=Original
        }
    </script>
