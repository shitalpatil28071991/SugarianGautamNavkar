<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTransportpaidFreightdetailRegister.aspx.cs" Inherits="Sugar_Report_rptTransportpaidFreightdetailRegister" %>
...
<body>
    ...
    <div>
          <asp:Button ID="btnprintdialog" Text="Print" runat="server" OnClientClick="return Print()" />
            ...
            <CR:CrystalReportViewer ID="CryTransportpaidFreightdetailRegister" runat="server" AutoDataBind="true" />
    </div>
