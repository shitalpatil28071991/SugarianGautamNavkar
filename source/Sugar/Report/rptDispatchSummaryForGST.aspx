<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDispatchSummaryForGST.aspx.cs"
    Inherits="Report_rptDispatchSummaryForGST" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Dispatch Summary For GST</title>
        ...
        <asp:Panel runat="server" ID="pnlMain" align="center" Font-Names="calibri" CssClass="print3">
            ...
            <table id="Table1" runat="server" width="95%" align="center" cellspacing="2" style="table-layout: fixed;
                ...
                <tr>
                    ...
                    <td style="width: 1%" align="left">
                        <asp:Label runat="server" ID="Label9" Font-Bold="true" Text="Mill Rate With GST"></asp:Label>
                    </td>
                    ...
                    <td style="width: 2%" align="center">
                     ...
                     <td style="width: 2%" align="center">
                        <asp:Label runat="server" ID="Label11" Font-Bold="true" Text="Eway Bill No"></asp:Label>
                    </td>
                </tr>
            </table>
                                                ...
                                                <ItemTemplate>
                                                    <table id="Table1" runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 1%" align="left">
                                                                <asp:Label runat="server" ID="Label10" Font-Bold="false" Text='<%#Eval("GSTRate") %>'></asp:Label>
                                                            </td>
                                                            <td style="width: 2%" align="center">
                                                            ...
                                                            <td style="width: 2%" align="center">
                                                                <asp:Label runat="server" ID="Label12" Font-Bold="false" Text='<%#Eval("Eway_Bill_No") %>'></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate>
