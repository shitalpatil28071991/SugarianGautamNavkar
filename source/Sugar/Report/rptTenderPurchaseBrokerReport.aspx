<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTenderPurchaseBrokerReport.aspx.cs"
    Inherits="Report_rptTenderPurchaseBrokerReport" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryTrnderPSBrokerReport" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
