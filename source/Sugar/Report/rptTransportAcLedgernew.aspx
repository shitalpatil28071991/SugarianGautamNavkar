<%@ Page Title="rpt:TrnasportAc Ledger" Language="C#" AutoEventWireup="true" CodeFile="rptTransportAcLedgernew.aspx.cs"
    Inherits="Report_rptTransportAcLedgernew" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function sp(Tenderno, accode, Action) {
            var tn;
            window.open('../BussinessRelated/pgeDeliveryOrderForGSTxmlNew.aspx?DO=' + accode + '&tenderid=' + accode + '&Action=' + Action);    //R=Redirected  O=Original
        }
        function sp1(Tenderno, accode, Action) {
            var tn;
            window.open('../Outword/pgrSugarsaleForGSTxml.aspx?saleid=' + accode + '&tenderid=' + accode + '&Action=' + Action);    //R=Redirected  O=Original
        }
    </script>
</head>
<body>
        ...
        <asp:Panel runat="server" ID="pnlMain" CssClass="print">
            ...
            <table align="center" width="90%" class="print" style="border-bottom: double 1px gray;
                ...
                <tr>
                    ...
                    <td align="left" style="width: 3%;">
                        <asp:Label ID="Label7" runat="server" Text="Do No" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" style="width: 3%;">
                        <asp:Label ID="Label12" runat="server" Text="SB No" Font-Bold="true"></asp:Label>
                    </td>
                                                ...
                                                <ItemTemplate>
                                                    <table width="100%" align="center" class="print" style="table-layout: fixed; border-bottom: 1px solid black;">
                                                        <tr>
                                                            ...
                                                            <td align="left" style="width: 5%; vertical-align: top;">
                                                                <asp:Label ID="Label8" runat="server" Text='<%#Eval("billtoshortname") %>' Font-Bold="false"></asp:Label>
                                                            </td>
                                                            ...
                                                            <td align="right" style="width: 5%; vertical-align: top;">
                                                            ...
                                                            <td align="right" style="width: 5%; vertical-align: top;">
                                                                <asp:LinkButton Style="text-decoration: none;" runat="server" ID="linksb" Text='<%#Eval("SB_No") %>'
                                                                    OnClick="linksb_Click"></asp:LinkButton>
                                                            </td>
                                                            <td align="right" style="width: 5%; vertical-align: top;">
