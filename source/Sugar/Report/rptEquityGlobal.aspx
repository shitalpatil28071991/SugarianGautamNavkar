<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptEquityGlobal.aspx.cs" Inherits="Sugar_Report_rptEquityGlobal" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryEquityGlobal" runat="server" AutoDataBind="true" BestFitPage="False" Width="1500px" />
