<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptJawakSaleBillCry.aspx.cs" Inherits="Sugar_Report_rptJawakSaleBillCry" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="cryJawakSaleBill" runat="server" AutoDataBind="false" />
        </div>
