<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptUTRDetailReportNew.aspx.cs"
    Inherits="Report_rptUTRDetailReportNew" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryUTRDetailReport" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
