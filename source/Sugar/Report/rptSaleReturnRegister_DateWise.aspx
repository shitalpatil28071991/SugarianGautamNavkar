<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSaleReturnRegister_DateWise.aspx.cs" Inherits="Report_rptSaleReturnRegister_DateWise" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CrySaleReturnRegister" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
