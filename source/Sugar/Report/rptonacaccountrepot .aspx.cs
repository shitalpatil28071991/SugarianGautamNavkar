...
public partial class Sugar_Report_rptonacaccountrepot_ : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                Accode = Request.QueryString["Transport"];
                ...
                pagehead = "On A/C Entry Report from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryonAcAccount .rpt"));
                rprt1.SetDataSource(dt);
                CryonAcAccount.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (Accode == "0" || Accode ==string.Empty)
              {
                cmd = new SqlCommand("select * from qrytransheaddetail where  Company_Code=" + company_code + " and drpFilterValue='O' and Year_Code=" + year_code + " and doc_date between '" + datefrom + "' and '" + dateto + "'", con);

            }

            else
            {
                cmd = new SqlCommand("select * from qrytransheaddetail where credit_ac= '" + Accode + "' and drpFilterValue='O' and Company_Code=" + company_code + " and Year_Code=" + year_code + " and doc_date between '" + fromdt + "' and '" + todt + "'", con);
            }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryonAcAccount.ReportSource = null;

        CryonAcAccount.Dispose();
