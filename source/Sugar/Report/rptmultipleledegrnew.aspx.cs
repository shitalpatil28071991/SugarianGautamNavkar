...
public partial class Sugar_Report_rptmultipleledegrnew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("CryMultiplelegerfinal.rpt"));
                rprt1.SetDataSource(dt);
                CryMultiplelegerfinal.ReportSource = rprt1;
                ...
                CryMultiplelegerfinal.RefreshReport();
            }
            else
            {
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            //{
            SqlCommand cmd;
            cmd = new SqlCommand("select * from qryMultipalledgerfinal where  Company_Code=" + company_code + "   and Year_Code=" + year_code + " and DOC_DATE <='" + dateto + "'", con);
            cmd.CommandType = CommandType.Text;
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            sda.Fill(dt);
            //}
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryMultiplelegerfinal.ReportSource = null;

        CryMultiplelegerfinal.Dispose();
