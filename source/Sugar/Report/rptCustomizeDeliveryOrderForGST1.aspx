<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptCustomizeDeliveryOrderForGST1.aspx.cs" Inherits="Sugar_Report_rptCustomizeDeliveryOrderForGST1" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryDeliveryOrderForGST1" runat="server" AutoDataBind="false" />
    </div>
    </form>
</body>
</html>
