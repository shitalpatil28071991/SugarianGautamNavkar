...
public partial class Sugar_Report_pgeSaleBill_Print2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            rpt.Load(Server.MapPath("crySaleBill_Print2.rpt"));
            rpt.SetDataSource(dt);

            string docno = doc_no;
            docno = docno.PadLeft(6, '0');

            crySaleBill_Print2.ReportSource = rpt;
           ...
           // rpt.DataDefinition.FormulaFields["other"].Text = "\"" + other + "\"";
            ...
            crySaleBill_Print2.RefreshReport();
        }
        catch (Exception)
        {
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.crySaleBill_Print2.ReportSource = null;

        crySaleBill_Print2.Dispose();
