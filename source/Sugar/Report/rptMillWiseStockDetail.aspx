<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptMillWiseStockDetail.aspx.cs" Inherits="Sugar_Report_rptMillWiseStockDetail" %>
    ...
    <form id="form1" runat="server">
          <div id="printReady">
            ...
            <asp:TextBox runat="server" ID="txtEmail" Width="300px"></asp:TextBox>
              ...
              <CR:CrystalReportViewer ID="CrymillwiseStockDetails" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
