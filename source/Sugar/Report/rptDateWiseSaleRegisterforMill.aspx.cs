...
public partial class Sugar_Report_rptDateWiseSaleRegisterforMill : System.Web.UI.Page
{
    ...
    private DataTable GetData(string fromdt, string todt, string accode)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (Accode == "0")
            {
                cmd = new SqlCommand("select * from qrysaleheaddetail where doc_date between '" + datefrom + "' and '" + dateto
                    + "' and IsDeleted !='0'  and doc_no !='0' and  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) , con);
            }
            else
            {
                cmd = new SqlCommand("select * from qrysaleheaddetail where doc_date  between '" + datefrom + "' and '" + dateto
                    + "' and mill_code= '" + Accode + "' and IsDeleted !='0'  and doc_no !='0' and  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()), con);
            }
