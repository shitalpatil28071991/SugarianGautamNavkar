...
public partial class rptKird : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                SqlCommand cmd_for_sp = new SqlCommand("spdaybook", dbConnection);
                cmd_for_sp.CommandType = CommandType.StoredProcedure;
                cmd_for_sp.Parameters.Add("@fromdate", SqlDbType.Date).Value = fromdt;
                cmd_for_sp.Parameters.Add("@Todate", SqlDbType.Date).Value = todt;
                ...
                myDataSet_ForReport.DataSetName = "dsDay.xsd";
                myDataSet_ForReport.Tables[0].TableName = "qryDay"; //based on datatable name in .xsd
                myDataSet_ForReport.Tables[1].TableName = "qryDaycr";//second table
                myDataSet_ForReport.Tables[2].TableName = "qryDaydr";

                rprt1.Load(Server.MapPath("cryKird.rpt"));
                rprt1.SetDataSource(myDataSet_ForReport);
             //   rprt1.SetDataSource(dt);
                cryKird.ReportSource = rprt1;
    ...
    //        cmd = new SqlCommand("select * from qryDay where doc_date between '" + datefrom + "' and '" + dateto + "' ", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryKird.ReportSource = null;
