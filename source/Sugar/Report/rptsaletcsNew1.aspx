<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptsaletcsNew1.aspx.cs" Inherits="Sugar_Report_rptsaletcsNew1" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="Crysaletcs1" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
