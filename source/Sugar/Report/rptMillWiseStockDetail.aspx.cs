...
public partial class Sugar_Report_rptMillWiseStockDetail : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CrymillwiseStockDetails.rpt"));
                rpt.SetDataSource(dt);

                CrymillwiseStockDetails.ReportSource = rpt;
                ...
                CrymillwiseStockDetails.RefreshReport();
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrymillwiseStockDetails.ReportSource = null;

        CrymillwiseStockDetails.Dispose();
