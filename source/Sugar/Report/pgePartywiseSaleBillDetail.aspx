<%@ Page Title="Partywise Sale Bill Balance Detail Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgePartywiseSaleBillDetail.aspx.cs" Inherits="Report_pgePartywiseSaleBillDetail_Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" language="javascript">
        function FreightRegister(accode, FromDt, ToDt) {
            var tn;
            window.open('rptpartywiseSalebillBalnce.aspx?accode=' + accode + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }


        function FreightRegisterDetail(accode,  FromDt, ToDt) {
            var tn;
            window.open('rptpartywiseSalebillBalncedetail.aspx?accode=' + accode + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }
    </script>
    <script type="text/javascript" language="javascript">
        debugger;
        ...
        <table>
            <tr>
                <td align="left" style="width: 40%;">
                    <asp:Button ID="btnDetailRptNew" runat="server" Text="PartyWise SaleBill Balance Report" CssClass="btnHelp"
                        Width="220px" Height="24px" TabIndex="6" OnClick="btnDetailRptNew_Click" />
                </td>
                <td align="right">
                    <asp:Button ID="btnUTRNODOWise" runat="server" Text="PartyWise SaleBill Balance Detail Report " CssClass="btnHelp"
                        Width="260px" Height="24px" TabIndex="7" OnClick="btnUTRNODOWise_Click" />
                </td>
            </tr>
        </table>
        <table>
