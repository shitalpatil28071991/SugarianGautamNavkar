<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptReceiptPayment.aspx.cs" Inherits="Sugar_Report_rptReceiptPayment" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryReceiptPayment" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
