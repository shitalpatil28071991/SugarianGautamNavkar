<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptpaymentdetail.aspx.cs" Inherits="rptpaymentdetail" %>
...
<body>
    ...
    <div>
            ...
            <CR:CrystalReportViewer ID="Crypaymentdetail" runat="server" AutoDataBind="true" />
