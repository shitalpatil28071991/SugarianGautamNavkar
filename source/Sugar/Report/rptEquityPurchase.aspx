<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptEquityPurchase.aspx.cs" Inherits="Sugar_Report_rptEquityPurchase" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryEquityPurchase" runat="server" AutoDataBind="true" BestFitPage="False" Width="1500px" />
        </div>
    </form>
</body>
</html>
