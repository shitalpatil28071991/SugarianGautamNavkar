<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptJaggerySaudaProfit.aspx.cs"
    Inherits="Report_rptJaggerySaudaProfit" %>
    ...
    <div>
        <asp:Panel runat="server" ID="pnlMain" align="center" Font-Names="calibri" CssClass="largsize">
            <table width="80%" align="center" cellpadding="1" cellspacing="0" style="table-layout: fixed;"
                ...
                <tr>
                    <td style="width: 100%;" align="center">
                        <asp:Label runat="server" ID="Label11" Font-Bold="true" Text="Jaggary Suda Profit"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 100%;" align="center">
            ...
            <table width="100%" align="center" cellpadding="1" cellspacing="0" style="table-layout: fixed;
                ...
                <tr>
                    ...
                    <td align="right" style="width: 5%;">
                        <asp:Label ID="Label10" runat="server" Text="Profit" Font-Bold="true"></asp:Label>
                    </td>
                </tr>
            </table>
