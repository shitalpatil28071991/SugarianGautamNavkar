...
public partial class rptpaymentbalnce : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("CryPaymentpurbalnce.rpt"));
                rprt1.SetDataSource(dt);
                CryPaymentpurbalnce.ReportSource = rprt1;
                ...
                CryPaymentpurbalnce.RefreshReport();
            }
            else
            {
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                cmd = new SqlCommand("select * from qryManuallyPurchaseBalance where  Company_Code=" + company_code + "  and Year_Code=" + year_code + " and doc_date between '" + datefrom + "' and '" + dateto + "'", con);

            }

            else
            {
                cmd = new SqlCommand("select * from qryManuallyPurchaseBalance where Ac_Code= '" + Accode + "' and  Company_Code=" + company_code + " and Year_Code=" + year_code + " and doc_date between '" + fromdt + "' and '" + todt + "'", con);
            }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryPaymentpurbalnce.ReportSource = null;

        CryPaymentpurbalnce.Dispose();
