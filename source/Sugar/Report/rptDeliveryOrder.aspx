<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDeliveryOrder.aspx.cs" Inherits="Sugar_Report_rptDeliveryOrder" Title="rptDeliveryOrder"%>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryDeliveryOrder" runat="server" AutoDataBind="false" />
    </div>
    </form>
</body>
</html>
