<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptServiceBill.aspx.cs" Inherits="Sugar_Report_rptServiceBill" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="CryServiceBill" runat="server" AutoDataBind="true" />
