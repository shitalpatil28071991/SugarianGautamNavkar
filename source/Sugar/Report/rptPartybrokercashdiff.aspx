<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptPartybrokercashdiff.aspx.cs" Inherits="Sugar_Report_rptPartybrokercashdiff" %>
...
<body>
    ...
    <div>
            ...
            <CR:CrystalReportViewer ID="CryPartybrokercashdiff" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
