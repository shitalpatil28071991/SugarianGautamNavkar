...
public partial class Sugar_Report_rptDispSummarynew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "DispSummary from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryDispSummarynew.rpt"));
                rprt1.SetDataSource(dt);
                CryDispSummarynew.ReportSource = rprt1;
                ...
                rprt1.DataDefinition.FormulaFields["Action"].Text = "\"" + Action + "\"";
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        
        {
            ...
            cmd = new SqlCommand("select * from qrydohead where doc_date between '" + datefrom + "' and '" + dateto + "' and Year_Code='" + year_code + "' and company_code='"+company_code+"'and tran_type!='MM'", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryDispSummarynew.ReportSource = null;

        CryDispSummarynew.Dispose();
