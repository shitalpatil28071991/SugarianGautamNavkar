<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDelivery_Challan.aspx.cs" Inherits="Sugar_Report_rptDelivery_Challan" %>
...
<body>
    <form id="form1" runat="server">
     <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryDelivery_Challan" runat="server" AutoDataBind="false" />
    </div>
    </form>
</body>
</html>
