<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptReverseCharge.aspx.cs"
    Inherits="Foundman_Inword_rptReverseCharge" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="cryRCM" runat="server" AutoDataBind="true" BestFitPage="False"
            Width="1500px" />
    </div>
    </form>
</body>
