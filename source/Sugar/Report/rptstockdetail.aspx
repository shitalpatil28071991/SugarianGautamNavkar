<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptstockdetail.aspx.cs" Inherits="Sugar_Report_rptstockdetail"  Title="Total Stock"%>
...
<body>
    ...
    <div>
            ...
            <CR:CrystalReportViewer ID="CryStockBook_Detail" runat="server" AutoDataBind="true"
