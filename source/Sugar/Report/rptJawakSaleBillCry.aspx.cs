...
public partial class Sugar_Report_rptJawakSaleBillCry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            salebillparty = dt.Rows[0]["Cust_Code"].ToString();
            ...
            rpt.Load(Server.MapPath("cryJawakSaleBill.rpt"));
            rpt.SetDataSource(dt);



            cryJawakSaleBill.ReportSource = rpt;
           ...
           // rpt.DataDefinition.FormulaFields["gstno"].Text = "\"" + GSTNO + "\"";
            ...
            rpt.DataDefinition.FormulaFields["docno"].Text = "\"" + "J-" + doc_no + "\"";
           ...
           // rpt.DataDefinition.FormulaFields["Inv"].Text = "\"" + Inv + "\"";
            ...
            cryJawakSaleBill.RefreshReport();
        }
        catch (Exception)
        {
    ...
    private DataTable GetData()
    {
        try
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from NT_1_JawakSaleBillPrint where doc_no=" + doc_no +
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryJawakSaleBill.ReportSource = null;

        cryJawakSaleBill.Dispose();
