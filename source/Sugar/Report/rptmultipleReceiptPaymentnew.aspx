<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptmultipleReceiptPaymentnew.aspx.cs" Inherits="Sugar_Report_rptmultipleReceiptPaymentnew" %>
...
<body>
    ...
    <div>
            ...
            <CR:CrystalReportViewer ID="CrymultipleReceiptPayment" runat="server" AutoDataBind="true" />
