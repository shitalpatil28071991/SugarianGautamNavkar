<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptmahalaxmiSaleBill_Print.aspx.cs" Inherits="Sugar_Report_rptmahalaxmiSaleBill_Print" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="crymahalaxmiSaleBill_Print" runat="server" AutoDataBind="false" />
        </div>
