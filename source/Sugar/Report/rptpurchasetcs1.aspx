<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptpurchasetcs1.aspx.cs" Inherits="Sugar_Report_rptpurchasetcs1" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="Crypurchasetcs1" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
