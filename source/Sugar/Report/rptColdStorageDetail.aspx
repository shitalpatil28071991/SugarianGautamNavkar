<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptColdStorageDetail.aspx.cs" Inherits="Sugar_Report_rptColdStorageDetail" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="CryColdStorageDetail" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
