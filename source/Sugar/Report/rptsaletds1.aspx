<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptsaletds1.aspx.cs" Inherits="Sugar_Report_rptsaletds1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="Crysaletds" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
