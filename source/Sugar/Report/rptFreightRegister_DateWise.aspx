<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptFreightRegister_DateWise.aspx.cs" Inherits="Sugar_Report_rptFreightRegister_DateWise" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryFreight_Register" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
