<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptpaymentbalnce.aspx.cs" Inherits="rptpaymentbalnce" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryPaymentpurbalnce" runat="server" AutoDataBind="true" />
