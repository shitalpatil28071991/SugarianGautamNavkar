<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDispatchDetailsNewMill.aspx.cs" Inherits="Sugar_Report_rptDispatchDetailsNewMill" %>
...
<body>
    ...
    <div>
        <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri">
            ...
            <br />
            <asp:Label ID="Label15" runat="server" Width="90%" Text="Dispatch Details Report For Mill"
                                                    ...
                                                    <table width="100%" align="center" cellpadding="1" cellspacing="2" style="background-color: #00FFFF">
                                                        <tr>
                                                            ...
                                                            <td align="left" style="width: 10%;">
                                                             ...
                                                             <%--<td align="left" style="width: 10%;">
                                                                <asp:Label ID="lblShippedTo" runat="server" Text='<%# Eval("ShippedTo") %>' Font-Bold="true"></asp:Label>
                                                            </td>--%>
