...
using System.Data.SqlClient;
public partial class Sugar_Report_rptpartywiseSalebillBalncedetail : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CrypartywiseSalebillBalncedetail.rpt"));
                rpt.SetDataSource(dt);

                CrypartywiseSalebillBalncedetail.ReportSource = rpt;
                rpt.DataDefinition.FormulaFields["fromto"].Text = "\"PartywiseBalnceDetail report From " + datefrom + " To " + dateto + "\"";
                ...
                CrypartywiseSalebillBalncedetail.RefreshReport();
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (ac_code != "0")
            {
                SqlCommand cmd = new SqlCommand("select * from qrysalebillbalancedetail where  doc_date between '" + FromDt +
                   "' and '" + ToDt + "' and Ac_Code='" + ac_code + "'", con);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrysalebillbalancedetail where  doc_date between '" + from +
                    "' and '" + ToDt + "'", con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrypartywiseSalebillBalncedetail.ReportSource = null;

        CrypartywiseSalebillBalncedetail.Dispose();
