<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptOwnDO.aspx.cs" Inherits="Sugar_Report_rptOwnDO" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <cr:crystalreportviewer id="CryOwnDo" runat="server" autodatabind="true" bestfitpage="False" width="1500px" />
