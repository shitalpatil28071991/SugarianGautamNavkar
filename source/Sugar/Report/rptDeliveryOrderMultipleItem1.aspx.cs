...
public partial class Sugar_Report_rptDeliveryOrderMultipleItem1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            double millamt1 = 0.00;
            double millamt2 = 0.00;
            double millamttotal = 0.00;
            millamt1 = Convert.ToDouble(dt.Rows[0]["Mill_AmtWO_TCS"].ToString());
            millamt2 = Convert.ToDouble(dt.Rows[0]["mill_amountTCS1"].ToString());
            millamttotal = millamt1 + millamt2;
            string TotalAmount = millamttotal.ToString();
            string tdsrate = dt.Rows[0]["PurchaseTDSRate"].ToString();
            string mill_rate = dt.Rows[0]["mill_rate"].ToString();
            string quantal = dt.Rows[0]["quantal"].ToString();
            double basicamt = Convert.ToDouble(mill_rate) * Convert.ToDouble(quantal);
            ...
            rpt.Load(Server.MapPath("../Report/cryDeliveryOrderForGSTMutipleItem.rpt"));
