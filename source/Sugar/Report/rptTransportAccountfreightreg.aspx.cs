...
public partial class Sugar_Report_rptTransportAccountfreightreg : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CryrptTransportAccountfreightreg.rpt"));
                rpt.SetDataSource(dt);

                CryrptTransportAccountfreightreg.ReportSource = rpt;
                ...
                CryrptTransportAccountfreightreg.RefreshReport();
            }
            else
            {
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryrptTransportAccountfreightreg.ReportSource = null;

        CryrptTransportAccountfreightreg.Dispose();
