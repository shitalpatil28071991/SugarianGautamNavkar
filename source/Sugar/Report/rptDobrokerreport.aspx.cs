...
public partial class Sugar_Report_rptDobrokerreport : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CryDobrokerreport.rpt"));
                rpt.SetDataSource(dt);

                CryDobrokerreport.ReportSource = rpt;
                ...
                CryDobrokerreport.RefreshReport();
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (ac_code!="0")
            {
                SqlCommand cmd = new SqlCommand("select * from qrydohead where broker='" + ac_code + "' and doc_date between '" + datefrom.ToString() +
                   "' and '" + dateto.ToString() + "'", con);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrydohead where  doc_date between '" + datefrom.ToString() +
                   "' and '" + dateto.ToString() + "'", con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryDobrokerreport.ReportSource = null;

        CryDobrokerreport.Dispose();
