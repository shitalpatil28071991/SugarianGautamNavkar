<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pgeGrainSaleBill_Print.aspx.cs" Inherits="Sugar_Outword_pgeGrainSaleBill_Print" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="cryGrainSaleBill" runat="server" AutoDataBind="false" />
        </div>
