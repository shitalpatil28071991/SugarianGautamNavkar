<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDoCashdiff.aspx.cs" Inherits="Sugar_Report_rptDoCashdiff" %>
...
<body>
    <form id="form1" runat="server">
     <div>
            ...
            <CR:CrystalReportViewer ID="CryDocashdiff" runat="server" AutoDataBind="true" />
        </div>
