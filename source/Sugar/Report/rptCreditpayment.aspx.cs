...
public partial class Sugar_Report_rptCreditpayment : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CryCreditPaymnet.rpt"));
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (ac_code != "0")
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from qryMillpaymentBalancewithdispatch where  payableamount!=0 and Tender_Date between '" + from +
                       "' and '" + to + "' and  Payment_To='" + ac_code + "' and IsDeleted!=0 and   Company_Code='"
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from qryMillpaymentBalancewithdispatch where Tender_Date between '" + from +
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string pdfname = filepath + "\\UTRCreditPayment.pdf";
    ...
    protected void btnMail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtEmail.Text != string.Empty)
            {
                ...
                contentType.Name = "UTRCreditPayment";
