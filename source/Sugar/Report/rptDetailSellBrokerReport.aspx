<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDetailSellBrokerReport.aspx.cs"
    Inherits="Report_rptDetailSellBrokerReport" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryDetailSellBrokerReport" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
