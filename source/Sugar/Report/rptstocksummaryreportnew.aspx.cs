...
public partial class Sugar_Report_rptstocksummaryreportnew : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("Crystocksummaryreportnew.rpt"));
                rpt.SetDataSource(dt);

                Crystocksummaryreportnew.ReportSource = rpt;
                rpt.DataDefinition.FormulaFields["fromto"].Text = "\" Stock Summary Report From " + datefrom + " To " + dateto + "\"";
                ...
                Crystocksummaryreportnew.RefreshReport();
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qrypurchaseselfbalance where  doc_dateConverted between '" + from +
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.Crystocksummaryreportnew.ReportSource = null;

        Crystocksummaryreportnew.Dispose();
