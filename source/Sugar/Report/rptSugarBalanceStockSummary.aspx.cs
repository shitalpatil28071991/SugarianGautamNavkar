...
public partial class Sugar_Report_rptSugarBalanceStockSummary : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Balance Stock Summary Register";
               ...
               // dateto = DateTime.Parse(todt, System.Globalization.CultureInfo.CreateSpecificCulture("en-GB")).ToString("yyyy-MM-dd");
                ...
                rprt1.Load(Server.MapPath("CrySugarBalanceStockSummary.rpt"));
                rprt1.SetDataSource(dt);
                CrySugarBalanceStockSummary.ReportSource = rprt1;
    ...
    private DataTable GetData()
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (Accode != "0")
            {
                cmd = new SqlCommand("select * from qryDayPatrakReport where Company_Code=" + company_code + " and Year_Code=" + year_code +
                    " and self<> 0 or UnLiftedQntl <> 0  order by MillShortName, Lifting_Date", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrySugarBalanceStockSummary.ReportSource = null;

        CrySugarBalanceStockSummary.Dispose();
