...
public partial class Sugar_Report_rptPaymentNote : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("cryPaymentNote.rpt"));
                rprt1.SetDataSource(dt);
                cryPaymentNote.ReportSource = rprt1;
    ...
    private DataTable GetData()
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryPaymentNote where doc_no=" + docno +
    ...
    {
        this.cryPaymentNote.ReportSource = null;

        cryPaymentNote.Dispose();
