<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptRetailBillSummary.aspx.cs" Inherits="Sugar_Report_rptRetailBillSummary" %>
...
<body>
    ...
    <asp:Button ID="btnPDF" runat="server" Text="Open PDF" Width="80px" OnClientClick="return CheckEmail();"
            ...
            <CR:CrystalReportViewer ID="CryRetailBillSummary" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
