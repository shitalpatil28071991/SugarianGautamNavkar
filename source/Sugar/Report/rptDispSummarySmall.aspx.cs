...
public partial class Report_rptDispSummarySmall : System.Web.UI.Page
{
    ...
    private void BindList()
    {
     ...
     " getpassname as getpass,truck_no as truck,voucher_no as VN,voucher_type as VT,memo_no as MM,SB_No as SB ," +
      ...
      "purc_order as purcorder,driver_no,isnull(billtoshortname,billtoshortname) as billto,isnull(shiptoshortname,shiptoname) as shifto,doc_date "
    ...
    protected void DataList_ItemDataBound(object sender, DataListItemEventArgs e)
    {
        ...
        DataView view = new DataView(dt2, "doc_date='" + lbldodate.Text + "'", "doc_date", DataViewRowState.CurrentRows);
        DataTable selectedvalue = view.ToTable(true, "no", "mill", "millrate", "quantal", "getpass", "truck", "VN", "VT", "MM", "SB", "transport", "do", "purcno", "purcorder",
            "driver_no", "billto", "shifto", "doc_date");
        ...
        if (selectedvalue.Rows.Count > 0)
        {
            ...
            if (selectedvalue.Rows.Count > 0)
            {
                for (int i = 0; i < selectedvalue.Rows.Count; i++)
                {
                    ...
                    dr["driver_no"] = selectedvalue.Rows[i]["driver_no"].ToString();
