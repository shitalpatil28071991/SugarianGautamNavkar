<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptPendingSale.aspx.cs" Inherits="Sugar_Report_rptPendingSale" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <cr:crystalreportviewer id="CryPendingSale" runat="server" autodatabind="true" bestfitpage="False" width="1500px" />
