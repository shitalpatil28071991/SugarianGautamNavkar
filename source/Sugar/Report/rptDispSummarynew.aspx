<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDispSummarynew.aspx.cs" Inherits="Sugar_Report_rptDispSummarynew" %>
...
<body>
    <form id="form1" runat="server">
     <div>
         ...
         <CR:CrystalReportViewer ID="CryDispSummarynew" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
