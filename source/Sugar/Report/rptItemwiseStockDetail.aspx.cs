...
public partial class Sugar_Report_rptItemwiseStockDetail : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CryItemwiseStockDetails.rpt"));
                rpt.SetDataSource(dt);

                CryItemwiseStockDetails.ReportSource = rpt;
                ...
                CryItemwiseStockDetails.RefreshReport();
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qrypurcheswisedata where  doc_dateConverted between '" + from +
              "' and '" + ToDt + "' and selfBal='Y' and Brand_Code !=0 and PD_ID!=0", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryItemwiseStockDetails.ReportSource = null;

        CryItemwiseStockDetails.Dispose();
