<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTaxRegister.aspx.cs" Inherits="Sugar_Report_rptTaxRegister" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryTaxRegister" runat="server" AutoDataBind="true" BestFitPage="False" Width="1500px" />
