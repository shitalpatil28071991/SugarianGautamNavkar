...
public partial class Sugar_Report_rptNewDispatchRegisterPrint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                //paymentto = Request.QueryString["payment_to"];
               ...
               // fromdt = Request.QueryString["fromdt"];
                ...
                rprt1.Load(Server.MapPath("CryDispatchPrint.rpt"));
                rprt1.SetDataSource(dt);
                CryDispatchPrint.ReportSource = rprt1;
    ...
    private DataTable GetData()
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qrydohead where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and "
             + " year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and Delivery_Type !='D' and purc_no!=0 and SB_No!=0 and doc_date between  '" + fromDT + "' and '" + toDT + "' order by millshortname asc", con);
    ...
    {
        this.CryDispatchPrint.ReportSource = null;

        CryDispatchPrint.Dispose();
