...
public partial class Sugar_Report_rptGroupTender : System.Web.UI.Page
{ 
    int company_code;
    int year_code; 
    ...
    { 
        ...
        rpt.Load(Server.MapPath("~/Sugar/Report/cryGrouptender.rpt"));
        rpt.SetDataSource(dt);

        cryGrouptender.ReportSource = rpt;
        cryGrouptender.RefreshReport();
    ...
    { 
        this.cryGrouptender.ReportSource = null;

        cryGrouptender.Dispose();
