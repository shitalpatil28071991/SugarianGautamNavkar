<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptGroupTender.aspx.cs" Inherits="Sugar_Report_rptGroupTender" %>
...
<body>
  <form id="form1" runat="server">
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryGrouptender" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
