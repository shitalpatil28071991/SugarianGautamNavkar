...
public partial class Sugar_Report_rptCashReceiveReport : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CryCashReceiveReport.rpt"));
                rpt.SetDataSource(dt);

                CryCashReceiveReport.ReportSource = rpt;
                rpt.DataDefinition.FormulaFields["fromto"].Text = "\"Cash Receive Report From " + datefrom + " To " + dateto + "\"";
                ...
                CryCashReceiveReport.RefreshReport();
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryRetailSale where  Doc_Date between '" + FromDt +
                "' and '" + ToDt + "'and CashRecieve='true' and IsDelete!=0 ", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryCashReceiveReport.ReportSource = null;

        CryCashReceiveReport.Dispose();
