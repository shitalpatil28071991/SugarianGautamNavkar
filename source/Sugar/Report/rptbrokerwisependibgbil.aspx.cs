...
public partial class Sugar_Report_rptbrokerwisependibgbil : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("Crybrokerwisependibgbil.rpt"));
                rprt1.SetDataSource(dt);
                Crybrokerwisependibgbil.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if ( Accode!="0")
            {
                cmd = new SqlCommand("select * from qrysalebillbalance where BROKER=" + Accode + " and doc_date between '" + datefrom + "' and '" + dateto + "' and BROKER!=0", con);
            }
            else
            {
                cmd = new SqlCommand("select * from qrysalebillbalance where doc_date between '" + datefrom + "' and '" + dateto + "' and BROKER!=0", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.Crybrokerwisependibgbil.ReportSource = null;

        Crybrokerwisependibgbil.Dispose();
