<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptpendingGroupTender.aspx.cs" Inherits="Sugar_Report_rptpendingGroupTender" %>
...
<head id="Head1" runat="server">
    <script type="text/javascript">
        function Open(id) {
            var Action = 1;
            window.open('../BussinessRelated/pgeGroupTenderPurchase.aspx?grouptenderid=' + id + '&Action=' + Action, "_blank");
        }
                ...
                <HeaderTemplate>
                    <table class="my-table" width="1000px" align="center">
                        <tr class="my-row-header">
                            ...
                            <td class="my-cell">Mill Name</td>
                            <td class="my-cell">Group Name</td>
                            <td class="my-cell">Quantal</td>
                        </tr>
                    </table>
                </HeaderTemplate>
                <ItemTemplate>
                    <table class="my-table" width="1000px" align="center">
                        <tr class="my-row">
                            <td class="my-cell">
                                <asp:LinkButton runat="server" ID="lbkTenderNo" Text='<%#Eval("Tender_No") %>' OnClick="lbkTenderNo_Click"></asp:LinkButton>
                            ...
                            <td class="my-cell">
                                <asp:Label ID="Label4" runat="server" Text='<%#Eval("millName") %>'></asp:Label>
                            </td>
                            <td class="my-cell">
                                <asp:Label ID="Label1" runat="server" Text='<%#Eval("GroupName") %>'></asp:Label>
                            </td>
                            <td class="my-cell">
                                <asp:Label ID="Label2" runat="server" Text='<%#Eval("Quantal") %>'></asp:Label></td>
                        </tr>
                    </table>
                </ItemTemplate>
            </asp:DataList>
