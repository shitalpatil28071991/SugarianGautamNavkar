<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDeliveredReport.aspx.cs" Inherits="Sugar_Report_rptDeliveredReport" %>
    ...
    <form id="form1" runat="server">
          <div id="printReady">
            ...
            <asp:TextBox runat="server" ID="txtEmail" Width="300px"></asp:TextBox>
              ...
              <CR:CrystalReportViewer ID="CrydeliveredReport" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
