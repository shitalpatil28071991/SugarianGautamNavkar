<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDeliveryOrderPartyBill.aspx.cs" Inherits="Sugar_Report_rptDeliveryOrderPartyBill" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryDeliveryOrderPartyBill" runat="server" AutoDataBind="false" />
    </div>
    </form>
</body>
</html>
