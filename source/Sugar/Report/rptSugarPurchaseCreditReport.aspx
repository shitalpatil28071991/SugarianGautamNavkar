<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSugarPurchaseCreditReport.aspx.cs" Inherits="Sugar_Report_rptSugarPurchaseCreditReport" %>
    ...
    <form id="form1" runat="server">
          <div id="printReady">
            ...
            <asp:TextBox runat="server" ID="txtEmail" Width="300px"></asp:TextBox>
              ...
              <CR:CrystalReportViewer ID="CrySugarPurchaseCreditReport" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
