<%@ Page Title="rpt:Resale Diff To Recieve" Language="C#" AutoEventWireup="true" CodeFile="rptResaleDiffToRecieve.aspx.cs"
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function LV(no) {
            window.open('../Outword/pgeLocalVoucherForGSTxmlNew.aspx?commissionid=' + no + '&Action=1');
        }
    </script>
</head>
<body>
