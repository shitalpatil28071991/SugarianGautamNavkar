<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pgeLetterprint1.aspx.cs" Inherits="Sugar_Report_pgeLetterprint1" %>
...
<body>
   <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="cryletterprint" runat="server" AutoDataBind="false" />
        </div>
