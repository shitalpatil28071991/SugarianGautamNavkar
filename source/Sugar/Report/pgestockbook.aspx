<%@ Page Title="Stock Book Report" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="pgestockbook.aspx.cs" Inherits="Sugar_Report_pgestockbook" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function sbdr(fromdt, todt, Ac_Code) {
            window.open('rptstockbookunion.aspx?fromdt=' + fromdt + '&todt=' + todt + '&Ac_Code=' + Ac_Code);
        }
        function sbd(fromdt, todt, Ac_Code) {
            window.open('rptstockdetail.aspx?fromdt=' + fromdt + '&todt=' + todt + '&Ac_Code=' + Ac_Code);
        }
        function Retailstockbook(fromdt, todt, Ac_Code) {
            window.open('rptstockdetailSaudasale.aspx?fromdt=' + fromdt + '&todt=' + todt + '&Ac_Code=' + Ac_Code);
        }
    </script>
    ...
    <table width="60%" align="center">
        ...
        <tr>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnStockBookDetailReport" CssClass="btnHelp" Text="Stock Book Report"
                    Width="180px" Height="24px" OnClick="btnStockBookDetailReport_Click" />
            </td>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnStockBoookDetail" CssClass="btnHelp" Text="Stock Book Detail Report"
                    Width="180px" Height="24px" OnClick="btnStockBoookDetail_Click" />
            </td>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnretailstockbook" CssClass="btnHelp" Text="Retail Detail Report"
                    Width="180px" Height="24px" OnClick="btnretailstockbook_Click" />
            </td>
        </tr>
    </table>
