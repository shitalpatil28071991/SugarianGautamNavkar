...
public partial class Report_rptResaleDiffToRecieve : System.Web.UI.Page
{
    ...
    private void BindList()
    {
        try
        {
            ...
            //qry = "select Tender_DateConverted as tdate,Tender_No  as tno ,millshortname  as mill, tenderdoname as party ,Broker ,Quantal as quantal,Mill_Rate as millrate,Purc_Rate as purcrate,Voucher_No as voucher from qrytenderhead "
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        string strFile = "ResaleDifferenceToRecieve_report.xls";
