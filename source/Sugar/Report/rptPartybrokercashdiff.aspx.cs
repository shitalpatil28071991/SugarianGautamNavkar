...
public partial class Sugar_Report_rptPartybrokercashdiff : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Party Broker Cash Diff Report from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryPartybrokercashdiff.rpt"));
                rprt1.SetDataSource(dt);
                CryPartybrokercashdiff.ReportSource = rprt1;
                ...
                CryPartybrokercashdiff.RefreshReport();
            }
            else
            {
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                cmd = new SqlCommand("select * from qrytenderheaddetail where  Buyer_Party >2 and Company_Code=" + company_code + " and CashDifference!='0'  and Year_Code=" + year_code + " and Tender_Date between '" + datefrom + "' and '" + dateto + "'", con);

            }

            else
            {
                cmd = new SqlCommand("select * from qrytenderheaddetail where  Bp_Account >2 and Bp_Account= '" + Accode + "' and CashDifference!='0' and  Company_Code=" + company_code + " and Year_Code=" + year_code + " and Tender_Date between '" + fromdt + "' and '" + todt + "'", con);
            }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryPartybrokercashdiff.ReportSource = null;

        CryPartybrokercashdiff.Dispose();
