...
public partial class Sugar_Report_rptCustomerDo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            //  CryCustomerDo.ReportSource = rpt;
            ...
            //rpt.Load(Server.MapPath("../Report/CryCustomerDo.rpt"));
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryCustomerDo.ReportSource = null;

        CryCustomerDo.Dispose();
