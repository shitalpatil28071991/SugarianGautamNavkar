<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSaleBillDetail.aspx.cs" Inherits="Sugar_Report_rptSaleBillDetail" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="Crymultiplesalereciptebill" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
