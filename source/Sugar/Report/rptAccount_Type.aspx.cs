...
public partial class Sugar_Report_rptAccount_Type : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("CryAccountType.rpt"));
                rprt1.SetDataSource(dt);
                CryAccountType.ReportSource = rprt1;
    ...
    private DataTable GetData(string type, int company_Code)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            if (type != "Z")
            {
                SqlCommand cmd = new SqlCommand("select * from qrymstaccountmaster where Ac_Type='" + type + "' and Company_Code='" + company_code + "'", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryAccountType.ReportSource = null;

        CryAccountType.Dispose();
