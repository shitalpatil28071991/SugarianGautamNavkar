...
public partial class Sugar_Report_rptReatilSelfBalnceDetail : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CryretailselfbalneceDetail.rpt"));
                rpt.SetDataSource(dt);

                CryretailselfbalneceDetail.ReportSource = rpt;
                ...
                CryretailselfbalneceDetail.RefreshReport();
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (ac_code != "0" && pur_no != "0")
            {
                SqlCommand cmd = new SqlCommand("select * from qryretailseflbalncedetail where  doc_date between '" + from +
                    "' and '" + ToDt + "'  and doc_no='" + pur_no + "' and mill_code='" + ac_code + "'", con);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qryretailseflbalncedetail where  doc_date between '" + FromDt +
                    "' and '" + ToDt + "'  and doc_no='" + pur_no + "'", con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
            }
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qryretailseflbalncedetail where  doc_date between '" + FromDt +
                   "' and '" + ToDt + "' and mill_code='" + ac_code + "'", con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
            }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryretailselfbalneceDetail.ReportSource = null;

        CryretailselfbalneceDetail.Dispose();
