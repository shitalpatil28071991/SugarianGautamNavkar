<%@ Page Title="rpt:Disp Grade Wise" Language="C#" AutoEventWireup="true" CodeFile="rptDispGradeWise.aspx.cs" Inherits="Sugar_Report_rptDispGradeWise" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryDispGradeWise" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
