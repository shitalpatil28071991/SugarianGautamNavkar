    ...
    protected void dtl_OnItemDataBound(object sender, DataListItemEventArgs e)
    {
        try
        {
            using (clsDataProvider obj = new clsDataProvider())
            {
                ...
                qry = "select distinct [doc_no],convert(varchar(10),[doc_date],103) as doc_date,[Ac_Name_E],[Qtys],[Total],[Khajarat],[Shub_Amount],[P_Pol_Amount],[PostPhone],[roundoff],[BillAmt],[Gst_No]"
