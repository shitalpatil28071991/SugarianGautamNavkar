...
public partial class Sugar_Report_rptcustomizeperformainvoice_Print : System.Web.UI.Page
{
    ...
    string cusomisedofilename = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            cusomisedofilename = Session["customisesb"].ToString();
            ...
            rpt.Load(Server.MapPath(cusomisedofilename));
            rpt.SetDataSource(dt);

            string docno = doc_no;
            docno = docno.PadLeft(6, '0');

            crycustomizeInvoice.ReportSource = rpt;
            ...
            crycustomizeInvoice.RefreshReport();
        }
        catch (Exception)
        {
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.crycustomizeInvoice.ReportSource = null;

        crycustomizeInvoice.Dispose();
