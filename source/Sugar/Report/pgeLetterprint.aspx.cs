...
public partial class Sugar_Report_pgeLetterprint : System.Web.UI.Page
{
    ...
    private DataTable GetData()
    {
        try
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from NT_1_Letter where  DOC_NO =" + doc_no + " and Year_Code="
                    + Session["year"].ToString() + " and Company_Code=" + Session["Company_Code"].ToString(), con);
