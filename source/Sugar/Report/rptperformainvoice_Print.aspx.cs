...
public partial class Sugar_Report_rptperformainvoice_Print : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            rpt.DataDefinition.FormulaFields["docno"].Text = "\"" + sbno + "\"";
           ...
           // rpt.DataDefinition.FormulaFields["heading"].Text = "\"" + "Performain Invoice" + "\"";
    ...
    private DataTable GetData()
    {
        try
        {
            ...
            string qry3 = "select * from nt_1_deliveryorder where Company_Code='" + Session["Company_Code"].ToString() + "'and doc_no='" + no + "' and Year_Code=" + Convert.ToInt32(Session["year"].ToString())+"";
