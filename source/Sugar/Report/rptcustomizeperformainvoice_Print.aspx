<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptcustomizeperformainvoice_Print.aspx.cs" Inherits="Sugar_Report_rptcustomizeperformainvoice_Print" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="crycustomizeInvoice" runat="server" AutoDataBind="false" />
        </div>
