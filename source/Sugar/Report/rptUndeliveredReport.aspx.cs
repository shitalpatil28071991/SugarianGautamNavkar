...
public partial class Sugar_Report_rptUndeliveredReport : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CryUndeliveredReport.rpt"));
                rpt.SetDataSource(dt);

                CryUndeliveredReport.ReportSource = rpt;
                rpt.DataDefinition.FormulaFields["fromto"].Text = "\"Undelivered Stock Report From " + datefrom + " To " + dateto + "\"";
                ...
                CryUndeliveredReport.RefreshReport();
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryRetailSale where  Doc_Date between '" + FromDt +
                "' and '" + ToDt + "' and Delivered='1' and IsDelete!=0", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryUndeliveredReport.ReportSource = null;

        CryUndeliveredReport.Dispose();
