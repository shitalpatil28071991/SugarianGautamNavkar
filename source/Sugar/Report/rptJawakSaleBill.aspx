<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptJawakSaleBill.aspx.cs"
    Inherits="Report_rptJawakSaleBill" %>
                            ...
                            <asp:DataList runat="server" ID="dtlist" Width="100%" OnItemDataBound="dtlist_OnItemDataBound"
                                ...
                                <ItemTemplate>
                                            ...
                                            <td style="width: 80%; vertical-align: top;" align="left" class="toosmall">
                                                <table width="100%" style="table-layout: fixed;" class="toosmall">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        <td align="center" style="width: 100%; font-family: Verdana; font-size: 10px;" class="toosmall">
                                    ...
                                    <table width="100%" align="center" cellspacing="4" style="table-layout: fixed; border-bottom: 1px solid black; border-top: 1px solid black;"
                                        class="toosmall">
                                        <tr>
                                            <td style="width: 100%; height: 10px; font-size: large; text-align: center; padding-top: 5px; padding-bottom: 5px;">
                                                <b>TAX INVOICE</b>
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width: 50%; border-right: 1px solid black; border-bottom: 1px solid black;"
                                                            ...
                                                            <table style="width: 100%; table-layout: fixed;" class="toosmall">
                                                                <tr>
                                                                    <td style="width: 30%; font-size: small;">Reverse Charge:
                                                                    </td>
                                                                    <td align="left" style="font-size: small;">NO
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="font-size: small;">Invoice No:
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td style="font-size: small;">Invoice Date:
                                                                    </td>
                                                                    <td align="left" style="font-size: small;">
                                                        ...
                                                        <td style="width: 50%; border-bottom: 1px solid black;" align="left" class="toosmall">
                                                            <table style="width: 100%;" class="toosmall">
                                                                <tr>
                                                                    <td align="left" style="width: 100%; font-size: small;">Consignee Name:
                                                                    <asp:Label ID="Label3" Text='<%#Eval("PartyName") %>' runat="server" Font-Bold="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left" style="width: 100%; font-size: small;">City:
                                                                    <asp:Label ID="Label4" Text='<%#Eval("city_name_e") %>' runat="server" Font-Bold="true" />
                                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; State Code:
                                                                ...
                                                                <tr>
                                                                    <td align="left" style="width: 30%; font-size: small;">GST Number:
                                                                    <asp:Label ID="Label19" Text='<%#Eval("Party_Gst") %>' runat="server" Font-Bold="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left" style="width: 100%; font-size: small;">HSN NO:
                                                                    <asp:Label ID="Label6" Text="17011410" runat="server" Font-Bold="true" />
                                                                    &nbsp; &nbsp; &nbsp; &nbsp;Lorry Number:
                                                                    <asp:Label ID="Label28" Text='<%#Eval("VEHICLE_NO") %>' runat="server" Font-Bold="true" />
                                                                   </td>

                                                                </tr>
                                                                <tr>
                                                                    <td align="left" style="width: 40%; font-size: small;">
                                                                        <asp:Label ID="Label10" Text='<%#Eval("PartyFASSINO") %>' runat="server"  Font-Bold="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                </tr>
                                    ...
                                    <table width="100%" align="center" cellspacing="2" style="font-size: medium; table-layout: fixed; border-bottom: 1px solid black; height: 110px;"
                                        class="toosmall">
                                        <tr>
                                            <td colspan="12">
                                                <table width="100%" align="center" style="table-layout: fixed; border-top: 1px double black; border-bottom: 1px double black;"
                                                    class="toosmall">
                                                    <tr>
                                                        <td style="width: 16%; font-size: small;" align="right"></td>
                                                        <td style="width: 12%; font-size: small;" align="right">
                                                            <b>Total Quantity:-</b>
                                                            <asp:Label Text="" runat="server" ID="lbltotalqauantity" />
                                                        </td>
                                                       
                                                        <td style="width: 10%; font-size: small;" align="right">
                                                            <b>Total Net Weight:-</b>
                                                        </td>
                                                        <td style="width: 10%; font-size: small;" align="left">
                                                            <asp:Label Text="" runat="server" ID="lbltotalnetwt" />
                                                        </td>
                                                        <td style="width: 20%; font-size: small;" align="right"></td>
                                        ...
                                        <tr style="border-top: 1px solid black;">
                                          ...
                                          <tr>
                                            <td style="width: 20%; font-size: small;" align="right" class="toosmall" colspan="10">
                                                <span style="text-align: left; float: left;" class="toosmall"></span><b>Taxable Amount</b>
                                            </td>
                                             <td></td>
                                            <td style="width: 10%; font-size: small;" align="right" class="toosmall">
                                                <asp:Label runat="server" ID="Label17" Text='<%#Eval("TaxableAmount") %>'></asp:Label>
                                            </td>

                                        </tr>
                                           <tr>
                                            <td style="width: 20%; font-size: small;" align="right" class="toosmall" colspan="10">
                                                <span style="text-align: left; float: left;" class="toosmall"></span><b>CGST</b>
                                            </td>
                                            <td style="width: 10%; font-size: small;" align="right" class="toosmall">
                                                <asp:Label runat="server" ID="Label16" Text='<%#Eval("CGST_Rate") %>'></asp:Label>
                                            </td>
                                            <td style="width: 10%; font-size: small;" align="right" class="toosmall">
                                                <asp:Label runat="server" ID="Label18" Text='<%#Eval("CGST_Amount") %>'></asp:Label>
                                            </td>
                                        </tr> 
                                           <tr>
                                            <td style="width: 20%; font-size: small;" align="right" class="toosmall" colspan="10">
                                                <span style="text-align: left; float: left;" class="toosmall"></span><b>SGST</b>
                                            </td>
                                            <td style="width: 10%; font-size: small;" align="right" class="toosmall">
                                                <asp:Label runat="server" ID="Label23" Text='<%#Eval("SGST_Rate") %>'></asp:Label>
                                            </td>
                                            <td style="width: 10%; font-size: small;" align="right" class="toosmall">
                                                <asp:Label runat="server" ID="Label24" Text='<%#Eval("SGST_Amount") %>'></asp:Label>
                                            </td>
                                        </tr>
                                           <tr>
                                            <td style="width: 20%; font-size: small;" align="right" class="toosmall" colspan="10">
                                                <span style="text-align: left; float: left;" class="toosmall"></span><b>IGST</b>
                                            </td>
                                            <td style="width: 10%; font-size: small;" align="right" class="toosmall">
                                                <asp:Label runat="server" ID="Label21" Text='<%#Eval("IGST_Rate") %>'></asp:Label>
                                            </td>
                                            <td style="width: 10%; font-size: small;" align="right" class="toosmall">
                                                <asp:Label runat="server" ID="Label22" Text='<%#Eval("IGST_Amount") %>'></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 20%; font-size: small;" align="right" class="toosmall" colspan="10">
                                        ...
                                        <tr>
                                            <td style="width: 30%; font-size: x-large; font-weight: bold; font-size: small;"
                                                align="right" class="toosmall" colspan="10">
                                                <span style="text-align: left; float: right;" class="toosmall"></span><b>Total Amount
                                                Rs.:</b>
                                            </td>
                                             <td></td>
                                            <td style="width: 20%; font-size: medium; font-weight: bold;" align="right" class="toosmall">
                                                <asp:Label runat="server" ID="lblBillAmount" Text='<%#Eval("BillAmt") %>'></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 30%; border-bottom: 1px solid black; font-size: small; font-weight: bold; font-size: small;"
                                                align="right" class="toosmall" colspan="10">
                                                <span style="text-align: left; float: right;" class="toosmall"></span><b>TCS %:</b>
                                                <asp:Label runat="server" ID="Label31" Text='<%#Eval("TCS_Rate").ToString()=="0.000" || Eval("TCS_Rate").ToString()=="0"?"":Eval("TCS_Rate","{0}") %>'></asp:Label>
                                            </td>
                                            <td style="width: 20%; border-bottom: 1px solid black; font-size: small; font-weight: bold;"
                                                align="right" class="toosmall"></td>
                                            <td style="width: 20%; border-bottom: 1px solid black; font-size: small; font-weight: bold;"
                                                align="right" class="toosmall">
                                                <asp:Label runat="server" ID="Label32" Text='<%#Eval("TCS_Amt").ToString()=="0.00" || Eval("TCS_Amt").ToString()=="0"?"":Eval("TCS_Amt","{0}") %>'></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 30%; border-bottom: 1px solid black; font-size: x-large; font-weight: bold; font-size: small;"
                                                align="right" class="toosmall" colspan="10">
                                                <span style="text-align: left; float: right;" class="toosmall"></span><b>Net Payable:</b>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="11" align="left" class="toosmall" style="font-size: small; padding-top: 6px;">Inwords Rs.:<asp:Label runat="server" ID="lblInwords" Font-Bold="true"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="100%" align="center" cellspacing="0" style="table-layout: fixed; height: 80px;"
                                        ...
                                        <tr>
                                            ...
                                            No:<asp:Label runat="server" ID="lblCompnayFSSAI_No" Text="" Font-Bold="true"></asp:Label></br>
                                            &nbsp;&nbsp;Eway Bill No:<asp:Label ID="lblEwayBill" Text='<%#Eval("Eway_Bill_No") %>' runat="server" Font-Bold="true"/></br>
                                            &nbsp;&nbsp;EInvoiceno No:<asp:Label ID="Label25" Text='<%#Eval("einvoiceno") %>' runat="server" Font-Bold="true"/></br>
                                            &nbsp;&nbsp;ACK No:<asp:Label ID="Label26" Text='<%#Eval("ackno") %>' runat="server" Font-Bold="true"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%;" align="left" class="toosmallforimg"></td>
                                        ...
                                        <tr>
                                            <td align="left" class="toosmallforimg" style="font-size: small;">1)This Invoice is for Goods sold to the above party only.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size: small;">2)We are not responsible for quality and contents of the Jaggery as it is processed
                                            by farmers & purchased directly from APMC market yard sangli.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="toosmallforimg" style="font-size: small;">3)Our Reponsibility entirely ceases as soon as the goods have been handed over to
                                            the carrier/transporter.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="toosmallforimg" style="font-size: small;">4)Invoice not paid within 10 days by Online transfer will be subject to interest
                                            @ 18%p.a.
                                            </td>
                                        </tr>
                                        <tr>
