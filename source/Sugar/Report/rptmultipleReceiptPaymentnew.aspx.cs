...
public partial class Sugar_Report_rptmultipleReceiptPaymentnew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                {
                    TotalAmount = Convert.ToDouble(dt.Rows[i]["Bill_Amount"]);
                    total = total + TotalAmount;
                     totalfinale = total;
                     TotFinal = totalfinale.ToString();
                     inWords = clsNoToWord.ctgword(TotFinal);
                }


                rprt1.Load(Server.MapPath("CrymultipleReceiptPayment.rpt"));
                rprt1.SetDataSource(dt);
                CrymultipleReceiptPayment.ReportSource = rprt1;
    ...
    private DataTable GetData()
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qrymultiplereceiptheaddetail where DOC_NO=" + Accode + " and  Tran_Type='" + TranType + "' and  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and "
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrymultipleReceiptPayment.ReportSource = null;

        CrymultipleReceiptPayment.Dispose();
