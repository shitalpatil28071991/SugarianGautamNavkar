<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptUnregisterBill.aspx.cs" Inherits="Sugar_Report_rptUnregisterBill" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="cryUnregisterBill" runat="server" AutoDataBind="false" />
        </div>
