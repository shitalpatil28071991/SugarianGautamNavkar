...
public partial class Sugar_Report_rptpendingGroupTender : System.Web.UI.Page
{
    ...
    private void bindData()
    {
        try
        {
            ...
            string qry = "";
            qry = "SELECT Tender_No,Tender_dateConverted as doc_Date,millName,GroupName,Quantal FROM qrygrouptenderhead where  (Prosess is null or Prosess='N')  and  Company_Code="
    ...
    protected void lbkTenderNo_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Session["TN_NO"] = No;
            int id = Convert.ToInt32(clsCommon.getString("select grouptenderid from GroupTenderPurchase where Tender_No=" + No +
