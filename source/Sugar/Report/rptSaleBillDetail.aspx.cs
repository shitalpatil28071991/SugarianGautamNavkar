...
public partial class Sugar_Report_rptSaleBillDetail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Sale Bill Detail Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("Crymultiplesalereciptebill.rpt"));
                rprt1.SetDataSource(dt);
                Crymultiplesalereciptebill.ReportSource = rprt1;
                ...
                Crymultiplesalereciptebill.RefreshReport();
            }
            else
            {
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (Accode != "0")
            {
                cmd = new SqlCommand("select * from qrymultiplereciptedetailreport where Ac_Code=" + Accode + "  and Company_Code=" + company_code + " and Year_Code="+ year_code +"", con);
            }
            else
            {
                cmd = new SqlCommand("select * from qrymultiplereciptedetailreport where  Company_Code=" + company_code + " and Year_Code=" + year_code + "", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.Crymultiplesalereciptebill.ReportSource = null;

        Crymultiplesalereciptebill.Dispose();
