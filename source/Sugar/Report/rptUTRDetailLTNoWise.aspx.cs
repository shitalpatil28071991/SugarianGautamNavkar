    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (utr_no != "0")
            {
                ...
                + Convert.ToInt32(Session["year"].ToString()) + "' and IsDeleted !=0 and Company_Code='"
            ...
            else if (ac_code != "0")
            {
                ...
                "' and '" + ToDt + "' and mill_code='" + ac_code + "' and IsDeleted !=0 and Year_Code='"
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qryutrdodetail where Lott_No is not null and doc_date between '" + FromDt +
                    "' and '" + ToDt + "' and UTRNo='" + utr_no + "' and mill_code='" + ac_code + "' and IsDeleted !=0 and Year_Code='"
                    + Convert.ToInt32(Session["year"].ToString()) + "' and Company_Code='"
                + Convert.ToInt32(Session["Company_Code"].ToString()) + "'", con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qryutrdodetail where Lott_No is not null and doc_date between '" + FromDt +
                    "' and '" + ToDt + "' and IsDeleted !=0 and Year_Code='"
                    + Convert.ToInt32(Session["year"].ToString()) + "' and Company_Code='"
                + Convert.ToInt32(Session["Company_Code"].ToString()) + "'", con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
