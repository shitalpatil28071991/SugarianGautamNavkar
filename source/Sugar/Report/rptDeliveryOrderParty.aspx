<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDeliveryOrderParty.aspx.cs" Inherits="Sugar_Report_rptDeliveryOrderParty" %>
...
<body>
    <form id="form1" runat="server">
     <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryDeliveryOrderParty" runat="server" AutoDataBind="false" />
    </div>
    </form>
</body>
</html>
