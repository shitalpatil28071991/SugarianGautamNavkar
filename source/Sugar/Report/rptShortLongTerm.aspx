<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptShortLongTerm.aspx.cs" Inherits="Sugar_Report_rptShortLongTerm" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryShortLongTerm" runat="server" AutoDataBind="true" BestFitPage="False" Width="1500px" />
