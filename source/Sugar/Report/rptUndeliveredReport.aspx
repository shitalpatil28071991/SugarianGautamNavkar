<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptUndeliveredReport.aspx.cs" Inherits="Sugar_Report_rptUndeliveredReport" %>
    ...
    <form id="form1" runat="server">
          <div id="printReady">
            ...
            <asp:TextBox runat="server" ID="txtEmail" Width="300px"></asp:TextBox>
              ...
              <CR:CrystalReportViewer ID="CryUndeliveredReport" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
