...
public partial class Sugar_Report_rptChequePrinting : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            rprt1.Load(Server.MapPath("cryChequePrinting.rpt"));
            rprt1.SetDataSource(dt);
            cryChequePrinting.ReportSource = rprt1;
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryChequePrinting.ReportSource = null;

        cryChequePrinting.Dispose();
