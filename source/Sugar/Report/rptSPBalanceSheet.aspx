<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSPBalanceSheet.aspx.cs" Inherits="Sugar_Report_rptSPBalanceSheet" Title="Rpt SP Balance Sheet New" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="cryBalanceSheet" runat="server" AutoDataBind="false" />
        </div>
