    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            if (Buy_Sale == "B")
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto + "' and Buy_Sale='B'", con);
                ...
                {
                    SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto + "' and Buy_Sale='B' and AC_Code='" + Accode + "'", con);
                    cmd.CommandType = CommandType.Text;
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    sda.Fill(dt);
                }
            ...
            else
            {
                if (Accode == string.Empty)
                {
                    SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto + "' and Buy_Sale='S'", con);
                    cmd.CommandType = CommandType.Text;
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    sda.Fill(dt);
                }
                ...
                {
                    SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto + "' and Buy_Sale='S' and AC_Code='" + Accode + "'", con);
                    cmd.CommandType = CommandType.Text;
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    sda.Fill(dt);
                }
