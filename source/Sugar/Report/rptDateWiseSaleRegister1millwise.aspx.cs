...
public partial class Sugar_Report_rptDateWiseSaleRegister1millwise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Sale List from " + fromdt + " To " + todt;
                ...
                CrySaleReportMillWise.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            if (Accode != "0")
            {
                SqlCommand cmd = new SqlCommand("select * from qrysalehead where doc_date between '" + datefrom + "' and '" + dateto + "' and Ac_Code='" + Accode + "'", con);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrysalehead where doc_date between '" + datefrom + "' and '" + dateto + "'", con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
            }
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = filepath + "\\SaleReportMillWise" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
    ...
    protected void btnMail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = filepath + "\\SaleReportMillWise_" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
            rprt1.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, filename);
            ...
            if (txtEmail.Text != string.Empty)
            {
                ...
                contentType.Name = "SaleReportMillWise";
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        this.CrySaleReportMillWise.ReportSource = null;

        CrySaleReportMillWise.Dispose();
