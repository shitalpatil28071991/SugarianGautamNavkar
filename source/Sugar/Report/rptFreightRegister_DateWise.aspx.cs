...
public partial class Sugar_Report_rptFreightRegister_DateWise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("CryFreight_Register.rpt"));
                rprt1.SetDataSource(dt);
                CryFreight_Register.ReportSource = rprt1;
                ...
                rprt1.DataDefinition.FormulaFields["vouchername"].Text = "\"" + voutchername + "\"";
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrydohead where Ac_Code = " + Accode + " and  doc_date between '" + datefrom + "' and '" + dateto + "'and company_code = " + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code = " + Convert.ToInt32(Session["year"].ToString()) + "", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryFreight_Register.ReportSource = null;

        CryFreight_Register.Dispose();
