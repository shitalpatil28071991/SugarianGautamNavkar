...
public partial class Sugar_Report_rptPendingSale : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Pending Sale from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryPendingSale.rpt"));
                rprt1.SetDataSource(dt);
                CryPendingSale.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            //sda.Fill(dt);
            SqlCommand cmd;
            cmd = new SqlCommand("select * from qryPendingSale where SelfBalance != 0 ", con);
            cmd.CommandType = CommandType.Text;
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            sda.Fill(dt);
        }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryPendingSale.ReportSource = null;

        CryPendingSale.Dispose();
