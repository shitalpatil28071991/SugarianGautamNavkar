<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDOInfo.aspx.cs" Inherits="Sugar_Report_rptDOInfo" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="CryDoInfo" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
