<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTenderPurchaseBrokerDetailReport.aspx.cs"
    Inherits="Report_rptTenderPurchaseBrokerDetailReport" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryTrnderPSBrokerReportDetails" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
