<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptperidoctribalnce.aspx.cs" Inherits="Sugar_Report_rptperidoctribalnce" %>
...
<body>
    ...
    <div>
            ...
            <CR:CrystalReportViewer ID="Cryperidoctribalnce" runat="server" AutoDataBind="true" />
