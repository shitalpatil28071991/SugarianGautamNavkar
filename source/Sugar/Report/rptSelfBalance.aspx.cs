...
public partial class Sugar_Report_rptSelfBalance : System.Web.UI.Page
{
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        rpt.Load(Server.MapPath("~/Sugar/Report/cryselfBalance.rpt"));
        rpt.SetDataSource(dt);

        cryselfBalance.ReportSource = rpt;
        cryselfBalance.RefreshReport();
    ...
    private DataTable GetData()
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            SqlCommand cmd = new SqlCommand("select GroupName ,Tender_No,Lifting_DateConverted,millShortName,Quantal,Grade,Buyer_Quantal from qryGroupTenderHeadDetail " +
                                                " where  Company_Code= '" + company_code + "' and Year_Code= '" + year_code + "' and Buyer_Quantal!=0  and membercode=2", con);
    ...
    {
        this.cryselfBalance.ReportSource = null;

        cryselfBalance.Dispose();
