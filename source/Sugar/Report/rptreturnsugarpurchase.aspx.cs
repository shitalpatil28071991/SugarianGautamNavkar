...
using System.Data.SqlClient;
public partial class Sugar_Report_rptreturnsugarpurchase : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                DataTable dt = GetData(company_code, year_code);

                salebillparty = dt.Rows[0]["Bill_To"].ToString();
                if (!IsPostBack)
                {
                ...
                rpt.Load(Server.MapPath("cryreturnpurchase.rpt"));
                rpt.SetDataSource(dt);

                cryreturnpurchase.ReportSource = rpt;
            ...
            + Session["Company_Code"].ToString() + "'");
                ...
                cryreturnpurchase.RefreshReport();
    ...
    private DataTable GetData(int from, int to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryReturnpurchaseBill where doc_no='" + ac_code + "' and Company_Code=" + from + " and Year_Code=" + to, con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryreturnpurchase.ReportSource = null;

        cryreturnpurchase.Dispose();
