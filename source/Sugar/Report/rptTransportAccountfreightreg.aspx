<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTransportAccountfreightreg.aspx.cs" Inherits="Sugar_Report_rptTransportAccountfreightreg" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
         ...
         <CR:CrystalReportViewer ID="CryrptTransportAccountfreightreg" runat="server" AutoDataBind="true" />
