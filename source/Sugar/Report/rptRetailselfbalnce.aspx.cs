...
public partial class Sugar_Report_rptRetailselfbalnce : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("Cryretailselfbalnece.rpt"));
                rpt.SetDataSource(dt);

                Cryretailselfbalnece.ReportSource = rpt;
                ...
                Cryretailselfbalnece.RefreshReport();
            }
            else
            {
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrypurchaseselfbalance where  doc_date between '" + from +
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrypurchaseselfbalance where  doc_date between '" + FromDt +
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.Cryretailselfbalnece.ReportSource = null;

        Cryretailselfbalnece.Dispose();
