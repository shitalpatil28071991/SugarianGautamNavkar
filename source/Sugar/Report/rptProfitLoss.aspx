<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptProfitLoss.aspx.cs" Inherits="Report_rptProfitLoss"
    EnableEventValidation="false" Title="Rpt Profit Loss"%>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td align="left" style="width: 70%;">
                                                ...
                                                <%--<asp:LinkButton Style="text-decoration: none;" runat="server" ID="lnkDO" Text='<%#Eval("groupname") %>'
                                                                    OnClick="lnkDO_Click"></asp:LinkButton>--%>
                                                <asp:Label ID="lblGroupNameR" runat="server" Text='<%#Eval("groupname") %>' Font-Bold="true"
                                                    Font-Size="12px"></asp:Label>
                                                &nbsp;
                                                <asp:Label ID="lblsummaryR" runat="server" Font-Size="11px" Text='<%#Eval("summary") %>'
                                            ...
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td align="left" style="width: 70%;">
                                                        ...
                                                        &nbsp;&nbsp;&nbsp<%--;<asp:Label ID="lblAcNameR" runat="server" Text='<%#Eval("acname") %>'
                                ...
                                <ItemTemplate>
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td align="right" style="width: 30%;">
                                                <asp:Label ID="lblGroupAmountL" runat="server" Text='<%#Eval("groupamount","{0:f2}") %>'
                                                    Font-Bold="true" Font-Size="14px"></asp:Label>&nbsp;&nbsp;
                                            </td>
                                        </tr>
                                    </table>
