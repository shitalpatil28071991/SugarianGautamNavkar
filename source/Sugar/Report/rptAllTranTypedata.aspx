<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptAllTranTypedata.aspx.cs" Inherits="Sugar_Report_rptAllTranTypedata_" %>
...
<body>
    ...
    <asp:Button ID="btnPDF" runat="server" Text="Open PDF" Width="80px" OnClientClick="return CheckEmail();"
            ...
            <CR:CrystalReportViewer ID="Crytrantypedata" runat="server" AutoDataBind="true" />
