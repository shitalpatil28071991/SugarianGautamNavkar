<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptbrokerwisependibgbil.aspx.cs" Inherits="Sugar_Report_rptbrokerwisependibgbil" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="Crybrokerwisependibgbil" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
