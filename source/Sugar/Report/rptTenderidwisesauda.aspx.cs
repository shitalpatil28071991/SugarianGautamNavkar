    ...
    private DataTable GetData(string FromDt, string ToDt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            if (ac_code ==string.Empty||ac_code == "0")
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from qrytenderheaddetail where  Sauda_Date between '" + FromDt +
                    "' and '" + ToDt + "' and Company_Code=" + company_code + "  ", con);
            ...
            else
            {
                ...
                {
                    //SqlCommand cmd = new SqlCommand("select * from qrytenderheaddetail where  Sauda_Date between '" + FromDt +
                    //  "' and '" + ToDt + "' and Mill_Code='" + ac_code + "' and Company_Code=" + company_code + " and Year_Code=" + year_code + "", con);


                    SqlCommand cmd = new SqlCommand("select * from qrytenderheaddetail where  Sauda_Date between '" + FromDt +
                   "' and '" + ToDt + "' and Mill_Code='" + ac_code + "' and Company_Code=" + company_code + " ", con);
                    cmd.CommandType = CommandType.Text;
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    sda.Fill(dt);
                }
                else
                {
                    ...
                    SqlCommand cmd = new SqlCommand("select * from qrytenderheaddetail where  Sauda_Date between '" + FromDt +
                      "' and '" + ToDt + "' and Buyer='" + ac_code + "' and Company_Code=" + company_code + " ", con);
