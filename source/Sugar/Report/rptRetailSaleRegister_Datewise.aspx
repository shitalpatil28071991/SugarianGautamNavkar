<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptRetailSaleRegister_Datewise.aspx.cs" Inherits="Report_rptRetailSaleRegister_Datewise" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryRetailSaleRegister" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
