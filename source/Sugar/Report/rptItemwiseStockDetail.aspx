<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptItemwiseStockDetail.aspx.cs" Inherits="Sugar_Report_rptItemwiseStockDetail" %>
    ...
    <form id="form1" runat="server">
          <div id="printReady">
            ...
            <asp:TextBox runat="server" ID="txtEmail" Width="300px"></asp:TextBox>
              ...
              <CR:CrystalReportViewer ID="CryItemwiseStockDetails" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
