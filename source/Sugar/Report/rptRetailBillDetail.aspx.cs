...
public partial class Sugar_Report_rptRetailBillDetail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("CryRetailBillDetail.rpt"));
                rprt1.SetDataSource(dt);
                CryRetailBillDetail.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (Accode != "0")
            {
                cmd = new SqlCommand("select * from qryRetailsalebillbalance where Party_Code=" + Accode + " and rptdate between '" + fromdt + "' and '" + todt + "'", con);
            }
            else
            {
                cmd = new SqlCommand("select * from qryRetailsalebillbalance where rptdate between '" + fromdt + "' and '" + todt + "' and Party_Code!='1' ", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryRetailBillDetail.ReportSource = null;

        CryRetailBillDetail.Dispose();
