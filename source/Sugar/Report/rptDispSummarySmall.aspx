<%@ Page Title="rpt:Dispatch Summary Small" Language="C#" AutoEventWireup="true"  EnableEventValidation="false"
    CodeFile="rptDispSummarySmall.aspx.cs" Inherits="Report_rptDispSummarySmall" %>
            ...
            <asp:Panel runat="server" ID="pnlMain" align="center" Font-Names="calibri" CssClass="print3">
                ...
                <table id="Table1" runat="server" width="95%" align="center" cellspacing="2" style="table-layout: fixed; border-top: 1px solid black; border-bottom: 1px solid black;"
                    ...
                    <tr>
                        ...
                        <td style="width: 5%" align="left">
                            <asp:Label runat="server" ID="Label9" Font-Bold="true" Text="Bill To"></asp:Label>
                        </td>
                        <td style="width: 5%" align="left">
                            <asp:Label runat="server" ID="Label10" Font-Bold="true" Text="Shift To"></asp:Label>
                        </td>
                                        ...
                                        <tr>
                                            <td style="width: 25%" align="left">
                                                ...
                                                <td style="width:95%" align="left">
                                                    <asp:Label runat="server" ID="lblTotalQntl" Font-Bold="true"></asp:Label>
                                                </td>
                                                    ...
                                                    <ItemTemplate>
                                                        <table id="Table1" runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed; background-color: #FFFFCC; border-bottom: 1px solid black;"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 5%" align="left">
                                                                    <asp:Label runat="server" ID="Label11" Font-Bold="false" Text='<%#Eval("billto") %>'></asp:Label>
                                                                </td>
                                                                <td style="width: 5%" align="left">
                                                                    <asp:Label runat="server" ID="Label12" Font-Bold="false" Text='<%#Eval("shifto") %>'></asp:Label>
                                                                </td>
                                                                <td style="width: 3%" align="center">
