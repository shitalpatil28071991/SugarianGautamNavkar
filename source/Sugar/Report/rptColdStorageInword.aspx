<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptColdStorageInword.aspx.cs" Inherits="Sugar_Report_rptColdStorageInword" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="CryColdStorageInword" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
