<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptMotor_Memo.aspx.cs" Inherits="Sugar_Report_rptMotor_Memo" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryMotor_Memo" runat="server" AutoDataBind="false" />
    </div>
    </form>
</body>
</html>
