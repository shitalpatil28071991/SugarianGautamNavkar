<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptPurchaseRegisterWithoutTDS.aspx.cs" Inherits="Sugar_Report_rptPurchaseRegisterWithoutTDS" %>
...
<head id="Head1" runat="server">
    <title>Jaggary Purchase Register Witout TDS</title>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Panel runat="server" ID="pnlMain" align="center" Font-Names="calibri" CssClass="largsize">
                ...
                <table width="90%" align="center" cellpadding="1" cellspacing="0" style="table-layout: fixed; border-bottom: solid 2px black; border-top: solid 2px black;"
                    class="print">
                    <tr>
                        ...
                        <td align="center" style="width: 1%;">
                            <asp:Label ID="Label4" runat="server" Text="Ac Code" Font-Bold="true"></asp:Label>
                        </td>
                ...
                <table width="90%" align="center" cellpadding="1" cellspacing="0" class="print">
                            ...
                            <asp:DataList ID="dtl" runat="server" Width="100%" CellSpacing="4" OnItemDataBound="dtl_OnItemDataBound">
                                <ItemTemplate>
                                    <table align="center" width="100%" cellpadding="1" cellspacing="0" style="table-layout: fixed;"
                                        ...
                                        <tr>
                                            <td style="width: 100%;">
                                                <table align="center" width="100%" cellpadding="1" cellspacing="0" style="table-layout: fixed; border-bottom: 1px solid black;"
                                                                ...
                                                                <ItemTemplate>
                                                                    <table align="center" width="100%" cellpadding="1" cellspacing="2" style="table-layout: fixed;"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center" style="width: 1%;">
                                                                                <asp:Label ID="lbldocno" runat="server" Text='<%#Eval("Ac_Code") %>' Font-Bold="false"></asp:Label>
                                                                            </td>
                                                                            <td align="left" style="width: 6%;">
                                                                            ...
                                                                            <td align="right" style="width: 2%;">
                                                                                <asp:Label ID="Label7" runat="server" Text='<%#Eval("AMOUNT") %>' Font-Bold="false"></asp:Label>
                                                                            </td>
                                                                            <td align="right" style="width: 1%;">
                                            ...
                                            <td style="width: 100%;">
                                                <table width="100%" align="center" cellspacing="0" cellpadding="1" style="table-layout: fixed;"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" style="width: 2%;">
                                                            <asp:Label ID="lblbillamount" runat="server" Text="" Font-Bold="true" Visible="false"></asp:Label>
                                                        </td>
                                                        <td align="right" style="width: 1%;">
                    ...
                    <tr>
                        <td style="width: 100%;">
                            <table align="center" width="100%" cellpadding="1" cellspacing="2" style="table-layout: fixed; border-bottom: 1px solid black; border-top: 1px solid black"
                                class="print">
                                <tr>
                                    <td align="center" style="width: 1%;">
