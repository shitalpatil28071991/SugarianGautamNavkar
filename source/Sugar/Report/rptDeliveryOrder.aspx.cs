...
using System.Data.SqlClient;
public partial class Sugar_Report_rptDeliveryOrder : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string narration1 = ds.Tables[0].Rows[0]["NARRATION3"].ToString();
            ...
            //  cryDeliveryOrder.ReportSource = rpt;
            ...
            rpt.Load(Server.MapPath("../Report/cryDeliveryOrder.rpt"));
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryDeliveryOrder.ReportSource = null;

        cryDeliveryOrder.Dispose();
