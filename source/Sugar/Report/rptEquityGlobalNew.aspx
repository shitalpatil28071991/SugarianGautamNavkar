<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptEquityGlobalNew.aspx.cs" Inherits="Sugar_Report_rptEquityGlobalNew" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryEquityGlobalNew" runat="server" AutoDataBind="true" BestFitPage="False" Width="1500px" />
