<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptstoreprocedureTrianlBalance.aspx.cs"
    Inherits="Report_rptstoreprocedureTrianlBalance" %>
                                                    ...
                                                    <ItemTemplate>
                                                        <table width="100%">
                                                            <tr>
                                                                ...
                                                                <%--<td align="right" style="width: 10%;">
                                                                    <asp:Label ID="Label9" runat="server" Font-Bold="false" Text='<%#Eval("Balance") %>'></asp:Label>
                                                                </td>--%>
                                                                <td align="right" style="width: 10%;">
