<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptsaletcsNew.aspx.cs" Inherits="Sugar_Report_rptsaletcsNew" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="Crysaletcs" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
