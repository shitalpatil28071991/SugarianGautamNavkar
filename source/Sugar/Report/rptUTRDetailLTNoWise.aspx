<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptUTRDetailLTNoWise.aspx.cs"
    Inherits="Report_rptUTRDetailLTNoWise" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryUTRDetailReportOnLTNO" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
