<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptReatilSelfBalnceDetail.aspx.cs" Inherits="Sugar_Report_rptReatilSelfBalnceDetail" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="CryretailselfbalneceDetail" runat="server" AutoDataBind="true" />
