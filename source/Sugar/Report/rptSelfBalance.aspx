<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSelfBalance.aspx.cs" Inherits="Sugar_Report_rptSelfBalance" %>
...
<body>
  <form id="form1" runat="server">
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryselfBalance" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
