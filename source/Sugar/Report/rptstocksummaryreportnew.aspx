<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptstocksummaryreportnew.aspx.cs" Inherits="Sugar_Report_rptstocksummaryreportnew" %>
    ...
    <form id="form1" runat="server">
     <div id="printReady">
            ...
            <asp:TextBox runat="server" ID="txtEmail" Width="300px"></asp:TextBox>
              ...
              <CR:CrystalReportViewer ID="Crystocksummaryreportnew" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
