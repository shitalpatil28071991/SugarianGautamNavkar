<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSelfSugarBalanceStock.aspx.cs" Inherits="Sugar_Report_rptSelfSugarBalanceStock" EnableEventValidation="false" %>
                    ...
                    <tr>
                        <td style="width: 90%;">
                            <asp:DataList runat="server" ID="dtlist" Width="100%" OnItemDataBound="dtlist_OnItemDataBound">
                                <ItemTemplate>
                                    <table width="100%" cellpadding="0" cellspacing="1" align="center" style="background-color: #FFFFCC; table-layout: fixed; border-bottom: 1px solid black;">
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="width: 100%;">
                                                <asp:DataList runat="server" ID="dtlDetails" Width="100%">
                                                    <ItemTemplate>
                                                        <table width="100%" align="center" cellspacing="4" style="table-layout: fixed; background-color: #CCFFFF; border-bottom: 1px dashed black;">
                                                            <tr>
                                                                <td style="width: 4%;" align="left">
