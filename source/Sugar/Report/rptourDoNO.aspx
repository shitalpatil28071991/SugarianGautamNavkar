<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptourDoNO.aspx.cs" Inherits="Sugar_Report_rptourDoNO" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="CryMultipleourdono" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
