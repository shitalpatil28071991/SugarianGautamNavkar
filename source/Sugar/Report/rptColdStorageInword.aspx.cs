...
public partial class Sugar_Report_rptColdStorageInword : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
        ...
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
               ...
               // string inWords = clsNoToWord.ctgword(TotalAmount);
                ...
                rpt.Load(Server.MapPath("CryColdStorageInword.rpt"));
                rpt.SetDataSource(dt);

                CryColdStorageInword.ReportSource = rpt;
                ...
                CryColdStorageInword.RefreshReport();
    ...
    private DataTable GetData()
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from qryColdStorageHeadDetail where Doc_No=" + doc_no + " and Company_Code=" + Session["Company_Code"].ToString() + " and Year_Code=" + Session["year"].ToString() + " ", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryColdStorageInword.ReportSource = null;

        CryColdStorageInword.Dispose();
