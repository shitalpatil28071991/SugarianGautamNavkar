<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptChequePrinting.aspx.cs" Inherits="Sugar_Report_rptChequePrinting" %>
...
<script type ="text/javascript"src="/crystalreportviewers13/js/crviewer/crv.js"></script>
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         ...
         function SB() {
             window.open('cryChequePrinting.pdf')
         }
...
<body>
    ...
    <div>
        ...
        <div id="printReady" class="ReportViewerContainerStyle">
            <CR:CrystalReportViewer ID="cryChequePrinting" runat="server" AutoDataBind="true" BestFitPage="false" Width="1500px"
                PrintMode="ActiveX" />
        </div>
    </div>
    </form>
