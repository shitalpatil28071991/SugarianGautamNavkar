<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptgrainsoftstockbook.aspx.cs" Inherits="Sugar_Report_rptgrainsoftstockbook" Title="Grain Stock Book" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryGrainsoftstockbook" runat="server" AutoDataBind="false" />
    </div>
    </form>
</body>
</html>