<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptPendingPurchase.aspx.cs" Inherits="Sugar_Report_rptPendingPurchase" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <cr:crystalreportviewer id="CryPendingPurchase" runat="server" autodatabind="true" bestfitpage="False" width="1500px" />
