<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptRetailBillDetail.aspx.cs" Inherits="Sugar_Report_rptRetailBillDetail" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <cr:crystalreportviewer id="CryRetailBillDetail" runat="server" autodatabind="true" bestfitpage="False" width="1500px" />
