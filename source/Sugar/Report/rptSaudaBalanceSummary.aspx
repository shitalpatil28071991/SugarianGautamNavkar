<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSaudaBalanceSummary.aspx.cs" Inherits="Sugar_Report_rptSaudaBalanceSummary" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="CrySaudaBalanceSummary" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
