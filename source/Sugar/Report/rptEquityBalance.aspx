<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptEquityBalance.aspx.cs" Inherits="Sugar_Report_rptEquityBalance" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryEquityBalance" runat="server" AutoDataBind="true" BestFitPage="False" Width="1500px" />
