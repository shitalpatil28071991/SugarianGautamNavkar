<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSaleBillBalance.aspx.cs" Inherits="Sugar_Report_rptSaleBillBalance" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CrySaleBillBalance" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
