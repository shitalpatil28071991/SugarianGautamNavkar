...
public partial class Sugar_Report_rptstockdetailSaudasale : System.Web.UI.Page
{
    ...
    string selfaccount = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                selfaccount = Session["SELF_AC"].ToString();
                ...
                rprt1.Load(Server.MapPath("CryStockBook_DetailSelf.rpt"));
                rprt1.SetDataSource(dt);
                CryStockBook_DetailSelf.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrystockbookDetailsefl where doc_date <='" + dateto + "' "+
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryStockBook_DetailSelf.ReportSource = null;

        CryStockBook_DetailSelf.Dispose();
