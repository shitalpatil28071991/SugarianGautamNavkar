<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptCashReceiveReport.aspx.cs" Inherits="Sugar_Report_rptCashReceiveReport" %>
    ...
    <form id="form1" runat="server">
          <div id="printReady">
            ...
            <asp:TextBox runat="server" ID="txtEmail" Width="300px"></asp:TextBox>
              ...
              <CR:CrystalReportViewer ID="CryCashReceiveReport" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
