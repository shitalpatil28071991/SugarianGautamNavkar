...
public partial class Sugar_Report_rptstockbookunion : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Stock Book from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryStockBookUnion.rpt"));
                rprt1.SetDataSource(dt);
                CryStockBook_Register.ReportSource = rprt1;
                ...
                rprt1.DataDefinition.FormulaFields["f"].Text = "\"" + dateto.ToString() + "\"";
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrystockbookfinal where doc_date  <= '" + todt + "' and  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " order by doc_date", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryStockBook_Register.ReportSource = null;

        CryStockBook_Register.Dispose();
