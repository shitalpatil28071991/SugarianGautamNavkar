<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptPurchaseRegister.aspx.cs" Inherits="Sugar_Report_rptPurchaseRegister" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryPurchaseRegister" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
