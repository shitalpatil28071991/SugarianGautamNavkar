<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptEquitySale.aspx.cs" Inherits="Sugar_Report_rptEquitySale" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryEquitySale" runat="server" AutoDataBind="true" BestFitPage="False" Width="1500px" />
        </div>
    </form>
</body>
</html>
