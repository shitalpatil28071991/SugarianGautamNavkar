...
public partial class Sugar_Report_rptDelivery_Challan : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            rpt.Load(Server.MapPath("cryDelivery_Challan.rpt"));
            rpt.SetDataSource(dt);


            cryDelivery_Challan.ReportSource = rpt;
            ...
            cryDelivery_Challan.RefreshReport();
        }
        catch (Exception ex)
        {
            clsLog.Publish(ex);
    ...
    private DataTable GetData()
    {
        try
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrydohead where  doid=" + doc_no + "", con);
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string pdfname = filepath + "\\DeliveryChallan.pdf";
    ...
    protected void btnMail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtEmail.Text != string.Empty)
            {
                ...
                contentType.Name = "DeliveryChallan";
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryDelivery_Challan.ReportSource = null;

        cryDelivery_Challan.Dispose();
