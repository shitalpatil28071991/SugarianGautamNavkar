<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptfreightRegister.aspx.cs" Inherits="Sugar_Report_rptfreightRegister" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
         ...
         <CR:CrystalReportViewer ID="CryfreightRegisternew" runat="server" AutoDataBind="true" />
