<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptNewDispatchRegisterPrint.aspx.cs" Inherits="Sugar_Report_rptNewDispatchRegisterPrint" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryDispatchPrint" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
