<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptUTRMillPaymentDetail.aspx.cs"
    Inherits="Report_rptUTRMillPaymentDetail" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryUTRMillPaymentDetail" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
