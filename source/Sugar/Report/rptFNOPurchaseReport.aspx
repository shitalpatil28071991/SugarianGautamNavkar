<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptFNOPurchaseReport.aspx.cs"
    Inherits="Sugar_Report_rptFNOPurchaseReport" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="CryFNOPurchaseReport" runat="server" AutoDataBind="true"
