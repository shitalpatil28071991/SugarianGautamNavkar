...
public partial class Sugar_Report_rptDeliveryOrderForGST2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            rpt.Load(Server.MapPath("cryDeliveryOrderForGST2.rpt"));
            ...
            cryDeliveryOrderForGST2.ReportSource = rpt;
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryDeliveryOrderForGST2.ReportSource = null;

        cryDeliveryOrderForGST2.Dispose();
