...
public partial class Sugar_Report_rptmahalaxmiDo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
         ...
         //   rpt.SetDataSource(dt);
          ...
          //  CrymahalaxmiDo.ReportSource = rpt;
           ...
           // " and Year_Code='" + Session["year"].ToString() + "'");
            ...
            rpt.Load(Server.MapPath("../Report/CrymahalaxmiDo.rpt"));
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrymahalaxmiDo.ReportSource = null;

        CrymahalaxmiDo.Dispose();
