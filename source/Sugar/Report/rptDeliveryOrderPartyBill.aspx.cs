...
public partial class Sugar_Report_rptDeliveryOrderPartyBill : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                string millmail = clsCommon.getString("Select Email_Id from qrymstaccountmaster where  Ac_Code='" + mill + "' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));



                if (ccmail != "0")
                {
                    txtEmail.Text = txtEmail.Text + "," + millmail + "," + ccmail;
                }
                else
                {
                    txtEmail.Text = txtEmail.Text + "," + millmail;
                }
            ...
            rpt.Load(Server.MapPath("cryDeliveryOrderPartyBill.rpt"));
            ...
            cryDeliveryOrderPartyBill.ReportSource = rpt;
    ...
    protected void btnMail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string getpassname = ds.Tables[0].Rows[0]["getpassname"].ToString();
            ...
            if (txtEmail.Text != string.Empty)
            {
                ...
                msg.IsBodyHtml = true;
                msg.Subject = "DO.No:" + Do + " " + Truck_No + " Qt:" + DOQntl + " " + getpassname;
                //msg.IsBodyHtml = true;
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryDeliveryOrderPartyBill.ReportSource = null;

        cryDeliveryOrderPartyBill.Dispose();
