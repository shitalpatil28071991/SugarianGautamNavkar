        ...
        <asp:Panel runat="server" ID="pnlMain" CssClass="largsize">
            ...
            <table id="Table1" runat="server" width="90%" align="center" cellspacing="2" style="table-layout: fixed;
                ...
                <tr>
                    ...
                    <td style="width: 3%" align="right">
                        <asp:Label runat="server" ID="Label28" Font-Bold="true" Text="With GST Amtount"></asp:Label>
                    </td>
                    <td style="width: 3%" align="right">
                    ...
                    <td style="width: 8%" align="center">
                        <asp:Label runat="server" ID="Label6" Font-Bold="true" Text="Bill To"></asp:Label>
                    </td>
                     <td style="width: 8%" align="center">
                        <asp:Label runat="server" ID="Label24" Font-Bold="true" Text="Ship To"></asp:Label>
                    </td>
                </tr>
            </table>
                                                    ...
                                                    <table id="Table1" runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 3%" align="right">
                                                              ...
                                                              <td style="width: 3%" align="right">
                                                                <asp:Label runat="server" ID="Label31" Font-Bold="false" Text='<%#Eval("WithGSTAmt") %>'></asp:Label>
                                                            </td>
                                                            <td style="width: 3%" align="right">
                                                            ...
                                                            <td style="width: 8%" align="center">
                                                             ...
                                                             <td style="width: 8%" align="center">
                                                                <asp:Label runat="server" ID="Label25" Font-Bold="false" Text='<%#Eval("shiptonames") %>'></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="17" style="border-bottom: 1px double black;">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate>
                                            ...
                                            <table id="Table1" runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed;"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 3%" align="right">
                                                     ...
                                                     <td style="width: 2%" align="right">
                                                        <asp:Label runat="server" ID="Label35" Font-Bold="false" Text=""></asp:Label>
                                                    </td>
                                                    ...
                                                    <td style="width: 3%" align="right">
                                                     ...
                                                     <td style="width: 3%" align="right">
                                                        <asp:Label runat="server" ID="Label33" Font-Bold="false" Text=""></asp:Label>
                                                    </td>
                                                    <td style="width: 2%" align="right">
                                                    ...
                                                    <td style="width: 8%" align="right">
                                                      ...
                                                      <td style="width: 8%" align="right">
                                                        <asp:Label runat="server" ID="Label26" Font-Bold="false" Text=""></asp:Label>
                                                    </td>
                ...
                <tr>
                    <td align="center">
                        <table id="Table2" runat="server" width="100%" align="center" cellspacing="2" style="table-layout: fixed;"
                            class="largsize">
                            <tr>
                                <td style="width: 1.50%" align="center">
                               ...
                               <td style="width: 1%" align="left">
                                ...
                                <td style="width: 3.50%" align="right">
