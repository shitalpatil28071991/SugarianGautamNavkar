...
public partial class Sugar_Report_rptPendingPurchase : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Pending Purchase from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryPendingPurchase.rpt"));
                rprt1.SetDataSource(dt);
                CryPendingPurchase.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            //if (Accode != "0")
            //{
            //    cmd = new SqlCommand("select * from qryowndo where doc_no=" + Accode + " and doc_date between '" + fromdt + "' and '" + todt + "' and GETPASSCODE = SaleBillTo", con);
            //}
            //else
            //{
            //    cmd = new SqlCommand("select * from qryowndo where doc_date between '" + fromdt + "' and '" + todt + "' ", con);
            ...
            SqlCommand cmd = new SqlCommand("select * from qryTenderPurchaseBalance where Pend != 0 and selfbalance != 0", con);
            cmd.CommandType = CommandType.Text;
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            sda.Fill(dt);
        }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryPendingPurchase.ReportSource = null;

        CryPendingPurchase.Dispose();
