<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptonacaccountrepot .aspx.cs" Inherits="Sugar_Report_rptonacaccountrepot_" %>
...
<body>
    ...
    <asp:Button ID="btnPDF" runat="server" Text="Open PDF" Width="80px" OnClientClick="return CheckEmail();"
            ...
            <CR:CrystalReportViewer ID="CryonAcAccount" runat="server" AutoDataBind="true" />
