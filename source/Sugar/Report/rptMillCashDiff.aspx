<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptMillCashDiff.aspx.cs" Inherits="Sugar_Report_rptMillCashDiff" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryMillCashDiff" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
