...
public partial class Sugar_Report_rptCustomizeDeliveryOrderForGST : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string sellnoteno = clsCommon.getString("select Sell_Note_No from qrytenderhead where Tender_No='" + tenderno + "' and Company_Code='" + Session["Company_Code"] + "' " +
             " and Year_Code='" + Session["year"].ToString() + "'");
            ...
            rpt.Load(Server.MapPath("../Report/cryCustomizeDeliveryOrderForGST.rpt"));
