<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptpartywiseSalebillBalncedetail.aspx.cs" Inherits="Sugar_Report_rptpartywiseSalebillBalncedetail" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="CrypartywiseSalebillBalncedetail" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
