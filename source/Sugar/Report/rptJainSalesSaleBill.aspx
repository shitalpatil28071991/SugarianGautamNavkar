<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptJainSalesSaleBill.aspx.cs" Inherits="Sugar_Report_rptJainSalesSaleBill" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="cryjainsalessalebill" runat="server" AutoDataBind="false" />
        </div>
