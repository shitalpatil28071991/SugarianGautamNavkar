<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptmultipleprint.aspx.cs" Inherits="Foundman_Report_rptmultipleprint" %>
...
<head runat="server">
    <title></title>
     ...
     <script type="text/javascript">
         ...
         function SB() {
             window.open('Crymultipleprint.pdf')
         }
...
<body>
    ...
    <CR:CrystalReportViewer ID="cryMultiplprintnew" runat="server" AutoDataBind="true" BestFitPage="false" Width="1500px"
                PrintMode="ActiveX" /> 
    </div>
    </form>
</body>
