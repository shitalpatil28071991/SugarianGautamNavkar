<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptPaymentNote.aspx.cs" Inherits="Sugar_Report_rptPaymentNote" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="cryPaymentNote" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
