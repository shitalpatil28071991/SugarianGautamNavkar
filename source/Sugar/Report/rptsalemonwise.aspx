<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptsalemonwise.aspx.cs" Inherits="Sugar_Report_rptsalemonwise" title="rptsalemonwise"%>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="Crysalemonwise" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
