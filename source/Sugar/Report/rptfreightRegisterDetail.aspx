<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptfreightRegisterDetail.aspx.cs" Inherits="Sugar_Report_rptfreightRegisterDetail" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="CryfreightRegisterDetail" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
