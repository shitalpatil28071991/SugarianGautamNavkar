<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptCommisionBill.aspx.cs" Inherits="Sugar_Report_rptCommisionBill" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryCommisionBill" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
