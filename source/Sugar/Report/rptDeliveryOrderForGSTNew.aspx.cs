...
using System.Data.SqlClient;
public partial class Sugar_Report_rptDeliveryOrderForGSTNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            // cmd_for_sp.Parameters.Add("@Company_name", SqlDbType.Int).Value = Company_name;
            ...
            myDataSet_ForReport.Tables[0].TableName = "qrydohead"; //based on datatable name in .xsd
            myDataSet_ForReport.Tables[1].TableName = "nt_1_dodetails";
