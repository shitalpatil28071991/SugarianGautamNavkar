<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptpurcmonwise.aspx.cs" Inherits="Sugar_Report_rptpurcmonwise"  title="rptpurchasemonwise"%>
...
<body>
      <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="Crypurcmonwise" runat="server" AutoDataBind="true" />
        </div>
    </form>
</body>
</html>
