<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptColdStorageBalance.aspx.cs"
    Inherits="Sugar_Report_rptColdStorageBalance" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="CryColdStorageBalance" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
