...
public partial class Sugar_Report_rpttenderpurregister : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("CrytenderprofitlossRegister.rpt"));
                rprt1.SetDataSource(dt);
                CrytenderprofitlossRegister.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                cmd = new SqlCommand("select * from qryProfitLossTender where Mill_Code=" + Accode + " and Tender_Date between '" + datefrom + "' and '" + dateto + "'", con);
            }
            else
            {
                cmd = new SqlCommand("select * from qryProfitLossTender where Tender_Date between '" + datefrom + "' and '" + dateto + "'", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrytenderprofitlossRegister.ReportSource = null;

        CrytenderprofitlossRegister.Dispose();
