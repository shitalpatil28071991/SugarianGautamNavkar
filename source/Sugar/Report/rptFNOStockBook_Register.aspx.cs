...
public partial class Sugar_Report_rptFNOStockBook_Register : System.Web.UI.Page
{
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto + "' and AutoCarry='N' ", con);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto + "'  and AC_Code='" + Accode + "' and AutoCarry='N'", con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
            }
