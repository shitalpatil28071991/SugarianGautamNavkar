<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptStockBook.aspx.cs" Inherits="Sugar_Report_rptStockBook" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CryStockBook" runat="server" AutoDataBind="true" BestFitPage="False" Width="1500px" />
        </div>
    </form>
</body>
</html>
