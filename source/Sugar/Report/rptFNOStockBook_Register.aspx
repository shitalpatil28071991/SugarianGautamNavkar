<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptFNOStockBook_Register.aspx.cs"
    Inherits="Sugar_Report_rptFNOStockBook_Register" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="CryFNOStockBook_Register" runat="server" AutoDataBind="true"
