<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptUTRMillPaymentSummary.aspx.cs"
    Inherits="Report_rptUTRMillPaymentSummary" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="CryMillPaymentSummary" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
