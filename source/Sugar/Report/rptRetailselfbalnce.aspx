<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptRetailselfbalnce.aspx.cs" Inherits="Sugar_Report_rptRetailselfbalnce" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="Cryretailselfbalnece" runat="server" AutoDataBind="true" />
