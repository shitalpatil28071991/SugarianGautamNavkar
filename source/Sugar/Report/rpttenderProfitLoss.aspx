<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpttenderProfitLoss.aspx.cs" Inherits="Sugar_Report_rpttenderProfitLoss" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="Crytenderprofitlossnew" runat="server" AutoDataBind="true" />
