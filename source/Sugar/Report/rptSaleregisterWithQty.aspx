<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSaleregisterWithQty.aspx.cs"
    Inherits="Report_rptSaleregisterWithQty" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Jaggary Sale Register With Qty</title>
        ...
        <asp:Panel runat="server" ID="pnlMain" align="center" Font-Names="calibri" CssClass="largsize">
            ...
            <table width="100%" align="center" cellpadding="1" cellspacing="0" style="table-layout: fixed;
                ...
                <tr>
                    ...
                    <td align="center" style="width: 1%;">
                        <asp:Label ID="Label24" runat="server" Text="30KG" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" style="width: 1%;">
                    </td>
                    <td align="center" style="width: 1%;">
                        <asp:Label ID="Label23" runat="server" Text="10Kg" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" style="width: 1%;">
                    </td>
                    <td align="center" style="width: 1%;">
                        <asp:Label ID="Label22" runat="server" Text="5kG" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" style="width: 1%;">
                    </td>
                    <td align="center" style="width: 1%;">
                        <asp:Label ID="Label21" runat="server" Text="Box" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" style="width: 1%;">
                    </td>
                    <td align="center" style="width: 1%;">
                        <asp:Label ID="Label19" runat="server" Text="5kgBox" Font-Bold="true"></asp:Label>
                    </td>
                </tr>
            </table>
                                                                ...
                                                                <table align="center" width="100%" cellpadding="1" cellspacing="2" style="table-layout: fixed;"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="width: 1%;">
                                                                            <asp:Label ID="Label30" runat="server" Text='<%#Eval("thirteenkg") %>' Font-Bold="false"></asp:Label>
                                                                        </td>
                                                                        <td align="left" style="width: 1%;">
                                                                        </td>
                                                                        <td align="right" style="width: 1%;">
                                                                            <asp:Label ID="Label29" runat="server" Text='<%#Eval("tenkg") %>' Font-Bold="false"></asp:Label>
                                                                        </td>
                                                                        <td align="left" style="width: 1%;">
                                                                        </td>
                                                                        <td align="right" style="width: 1%;">
                                                                            <asp:Label ID="Label28" runat="server" Text='<%#Eval("KG") %>' Font-Bold="false"></asp:Label>
                                                                        </td>
                                                                        <td align="left" style="width: 1%;">
                                                                        </td>
                                                                        <td align="right" style="width: 1%;">
                                                                            <asp:Label ID="Label27" runat="server" Text='<%#Eval("Box") %>' Font-Bold="false"></asp:Label>
                                                                        </td>
                                                                        <td align="right" style="width: 1%;">
                                                                            <asp:Label ID="Label20" runat="server" Text='<%#Eval("Fivekgbox") %>' Font-Bold="false"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </ItemTemplate>
                                        ...
                                        <td style="width: 100%;">
                                            <table width="100%" align="center" cellpadding="1" cellspacing="0" style="table-layout: fixed;"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" style="width: 2%;">
                                                        <asp:Label ID="Label31" runat="server" Text="" Font-Bold="true"></asp:Label>
                                                    </td>
                                                    <td align="right" style="width: 2%;">
                                                        <asp:Label ID="Label32" runat="server" Text="" Font-Bold="true"></asp:Label>
                                                    </td>
                                                    <td align="right" style="width: 2%;">
                                                        <asp:Label ID="Label33" runat="server" Text="" Font-Bold="true"></asp:Label>
                                                    </td>
                                                    <td align="right" style="width: 2%;">
            ...
            <table width="100%" align="center" cellpadding="1" cellspacing="0" style="table-layout: fixed;
                ...
                <tr>
                    ...
                    <td align="center" style="width: 1%;">
                        <asp:Label ID="lblThirtyKGTotal" runat="server" Text="" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" style="width: 1%;">
                    </td>
                    <td align="center" style="width: 1%;">
                        <asp:Label ID="lblTenKGtotal" runat="server" Text="" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" style="width: 1%;">
                    </td>
                    <td align="center" style="width: 1%;">
                        <asp:Label ID="lblFiveKGTotal" runat="server" Text="" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" style="width: 1%;">
                    </td>
                    <td align="center" style="width: 1%;">
                        <asp:Label ID="lblBoxTotal" runat="server" Text="" Font-Bold="true"></asp:Label>
                    </td>
                     <td align="left" style="width: 1%;">
                    </td>
                    <td align="center" style="width: 1%;">
                        <asp:Label ID="lblfivebox" runat="server" Text="" Font-Bold="true"></asp:Label>
                    </td>
                </tr>
            </table>
        </asp:Panel>
