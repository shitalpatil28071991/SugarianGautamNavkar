<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDobrokerreport.aspx.cs" Inherits="Sugar_Report_rptDobrokerreport" %>
...
<body>
    ...
    <div id="printReady">
       ...
       <CR:CrystalReportViewer ID="CryDobrokerreport" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
