<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptpurchasebill.aspx.cs" Inherits="Sugar_Report_rptpurchasebill" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="Crypurchasebill" runat="server" AutoDataBind="true" BestFitPage="false" Width="1500px" />
        </div>
    </form>
</body>
</html>
