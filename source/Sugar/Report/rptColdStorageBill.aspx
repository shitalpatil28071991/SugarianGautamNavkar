<%@ Page Language="C#" Title="Cold Storage Bill" AutoEventWireup="true" CodeFile="rptColdStorageBill.aspx.cs"
    Inherits="Sugar_Report_rptColdStorageBill" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="CryColdStorageBill" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
