<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pgeSaleBill_Print2.aspx.cs" Inherits="Sugar_Report_pgeSaleBill_Print2" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="crySaleBill_Print2" runat="server" AutoDataBind="false" />
        </div>
