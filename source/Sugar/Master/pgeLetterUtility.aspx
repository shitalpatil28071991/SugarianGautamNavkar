<%@ Page Title="U-Letter" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeLetterUtility.aspx.cs" Inherits="Sugar_Master_pgeLetterUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Master/pgeLetterUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(3).html($(this).find("AC_NAME").text());
            ...
            $('#gvCustomers').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    if (isNaN(Group_Code)) {
                        ...
                        window.open('../Master/pgeLetter.aspx?Doc_no=' + Group_Code + '&Action=' + Action);
                    }
                }
            });
    ...
    <script type="text/javascript">
        function GSTRateMaster() {
            var Action = 2;
            var Doc_No = 0;
            window.open("../Master/pgeLetterUtility.aspx", "_self")
            window.open('../Master/pgeLetter.aspx?Doc_no=' + Doc_No + '&Action=' + Action);
        }
    </script>
    <script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;     
                 <asp:Label ID="lblUtilityName" runat="server" Text="Letter" Font-Bold="True"
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="60"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="100px" DataField="DOC_DATE" HeaderText="Doc Date" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="AC_CODE" HeaderText="Ac Code" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="AC_NAME" HeaderText="Ac Name" />
