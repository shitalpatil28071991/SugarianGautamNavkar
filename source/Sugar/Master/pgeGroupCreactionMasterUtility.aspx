<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeGroupCreactionMasterUtility.aspx.cs" Inherits="Sugar_Master_pgeGroupCreactionMasterUtility" %>
 ...
 <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Master/pgeGroupCreactionMasterUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                ...
                $.each(customers, function () {
                    ...
                    $("td", row).eq(2).html($(this).find("MemberName1").text());
                    $("td", row).eq(3).html($(this).find("MemberName2").text());
                    $("td", row).eq(4).html($(this).find("MemberName3").text());
                    $("td", row).eq(5).html($(this).find("MemberName4").text());
                    $("td", row).eq(6).html($(this).find("MemberName5").text());
                    $("td", row).eq(7).html($(this).find("MemberName6").text());
                    $("td", row).eq(8).html($(this).find("MemberName7").text());
                    $("td", row).eq(9).html($(this).find("autoid").text());
    ...
    <script type="text/javascript">
        function Citymaster() {
            ...
            window.open('../Master/pgeGroupCreactionMaster.aspx?Doc_No=' + Doc_No + '&Action=' + Action);
        }
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                var Action = 1;
                var Doc_No = tableData[9];

                if (row_index > 0) {
                    if (isNaN(Doc_No)) {
                    }
                    else {
                        window.open('../Master/pgeGroupCreactionMaster.aspx?autoid=' + Doc_No + '&Action=' + Action);
                    }
                }
            });
     ...
     <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="Auto">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;        
                <asp:Label ID="lblUtilityName" runat="server" Text="Group Creaction Master" Font-Bold="True"
               ...
               ForeColor="#CC3300" Font-Size="Medium"></asp:Label>
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="60"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="50px" DataField="GroupName" HeaderText="Group Name" AccessibleHeaderText="center" />                    
                        <asp:BoundField HeaderStyle-Width="20px" DataField="MemberName1" HeaderText=" Member 1" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="MemberName2" HeaderText="Member 2" />
                         <asp:BoundField HeaderStyle-Width="50px" DataField="MemberName3" HeaderText="Member 3" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="MemberName4" HeaderText="Member 4" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="MemberName5" HeaderText="Member 5" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="MemberName6" HeaderText="Member 6" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="MemberName7" HeaderText="Member 7" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="autoid" HeaderText="Auto id" />
