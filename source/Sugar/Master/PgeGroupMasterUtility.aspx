<%@ Page Language="C#" Title="U-Group Master" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeGroupMasterUtility.aspx.cs" Inherits="Sugar_Master_PgeGroupMasterUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Master/PgeGroupMasterUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    var customer = $(this);
                    $("td", row).eq(0).html($(this).find("group_Code").text());
                    $("td", row).eq(1).html($(this).find("group_Name_E").text());
                    $("td", row).eq(2).html($(this).find("group_Type").text());
                    $("td", row).eq(3).html($(this).find("group_Summary").text());
                    $("td", row).eq(4).html($(this).find("group_Order").text());
                    $("td", row).eq(5).html($(this).find("bsid").text());
            ...
            $('#gvCustomers').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    ...
                    if (isNaN(Ac_Code)) {
                        ...
                        window.open('../Master/pgeBSgroupMaster.aspx?bsid=' + Ac_Code + '&Action=' + Action + '&group_Type=' + Tran_Type);
                    }
    ...
    <script type="text/javascript">
        function groupmaster() {
            ...
            window.open('../Master/pgeBSgroupMaster.aspx?Ac_Code=' + Ac_Code + '&Action=' + Action + '&group_Type=' + tran_type);
        }
    </script>
    <script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div>
                ...
                <asp:Label ID="Label3" runat="server" Text="Entries" Font-Bold="True"
                    ForeColor="#CC3300" Font-Size="Medium"></asp:Label>
                ...
                &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
            &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                <asp:Label ID="lblUtilityName" runat="server" Text="Group Master" Font-Bold="True"
           ...
           <asp:Label ID="Label2" runat="server" Text=" Search:" Font-Bold="True"
            ...
            <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="60"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-Width="10px" DataField="group_Code" HeaderText="Group Code" />
                    <asp:BoundField HeaderStyle-Width="50px" DataField="group_Name_E" HeaderText="Group Name" />
                    <asp:BoundField HeaderStyle-Width="10px" DataField="group_Type" HeaderText="Group Type" />
                    <asp:BoundField HeaderStyle-Width="10px" DataField="group_Summary" HeaderText="Group Summary" />
                    <asp:BoundField HeaderStyle-Width="10px" DataField="group_Order" HeaderText="Group Order" />
                    <asp:BoundField HeaderStyle-Width="10px" DataField="bsid" HeaderText="BsID" />
