<%@ Page Title="U-Cold Storage Outword" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeColdStorage_Utility.aspx.cs" Inherits="Sugar_Inword_pgeColdStorage_Utility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Outword/pgeColdStorage_Utility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(4).html($(this).find("Final_Amount").text());
                    $("td", row).eq(5).html($(this).find("csid").text());
            ...
            $('#gvCustomers').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    ...
                    if (isNaN(Ac_Code)) {
                        ...
                        window.open('../Outword/pgeServiceBillTwo.aspx?csid=' + Ac_Code + '&Action=' + Action);
                    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;   
             <asp:Label ID="lblUtilityName" runat="server" Text="Cold Storage Outword" Font-Bold="True"
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="25" AllowPaging="true" Width="1700px" Height="80"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="150px" DataField="Date" HeaderText="Date" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="150px" DataField="Cash_Credit" HeaderText="Cash Credit" />
                        <asp:BoundField HeaderStyle-Width="150px" DataField="Ac_Name_E" HeaderText="Customer" />
                        <asp:BoundField HeaderStyle-Width="70px" DataField="Final_Amount" HeaderText="Amount" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="csid" HeaderText="csid" />
