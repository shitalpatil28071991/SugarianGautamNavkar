<%@ Page Language="C#" Title="U-Sale Bill" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeSaleHeadUtility.aspx.cs" Inherits="Sugar_Master_PgeSaleHeadUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Outword/PgeSaleHeadUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(2).html($(this).find("billtoShortname").text());
                    $("td", row).eq(3).html($(this).find("billtogstno").text());
                    $("td", row).eq(4).html($(this).find("shiptoshortname").text());
                    $("td", row).eq(5).html($(this).find("NETQNTL").text());
                    $("td", row).eq(6).html($(this).find("Bill_Amount").text());
                    $("td", row).eq(7).html($(this).find("millshortname").text());
                    $("td", row).eq(8).html($(this).find("EWay_Bill_No").text());
                    $("td", row).eq(9).html($(this).find("ackno").text());
                    $("td", row).eq(10).html($(this).find("saleid").text()); 
                    $("td", row).eq(11).html($(this).find("IsDeleted").text());
                    $("td", row).eq(12).html($(this).find("DO_No").text());
                ...
                $(".billtoname").each(function () {
                    var searchPattern = new RegExp('(' + SearchTerm() + ')', 'ig');
                    $(this).html($(this).text().replace(searchPattern, "<span class = 'highlight'>" + SearchTerm() + "</span>"));
                });

                $(".shiptoname").each(function () {
                    var searchPattern = new RegExp('(' + SearchTerm() + ')', 'ig');
                    $(this).html($(this).text().replace(searchPattern, "<span class = 'highlight'>" + SearchTerm() + "</span>"));
                });
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    if (isNaN(Ac_Code)) {
                        ...
                        window.open('../Outword/pgrSugarsaleForGSTxml.aspx?saleid=' + Ac_Code + '&Action=' + Action);
                    }
                }
            });
    ...
    <script type="text/javascript">
        function SaleHead() {
            ...
            window.open('../Outword/pgrSugarsaleForGSTxml.aspx?doc_no=' + Ac_Code + '&Action=' + Action);
        }
    </script>
    <script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Label ID="Label2" runat="server" Text="Entries" Font-Bold="True"
                ForeColor="#CC3300" Font-Size="Medium"></asp:Label>
            <asp:Button ID="btnAdd" runat="server" Text="Add New" class="btnHelp" OnClientClick="SaleHead()"
                ValidationGroup="save" Width="90px" Height="24px" OnClick="btnAdd_Click" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;    
             <asp:Label ID="lblUtilityName" runat="server" Text="Sale Bill" Font-Bold="True"
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px"
                    ...
                    <Columns>
                        <asp:BoundField HeaderStyle-Width="30px" DataField="doc_no" HeaderText="Doc No"
                        ...
                        <asp:BoundField HeaderStyle-Width="100px" DataField="billtoShortname" HeaderText="Bill To Name" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="billtogstno" HeaderText="Bill To GST No" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="shiptoshortname" HeaderText="Ship To Name" />
                        ...
                        <asp:BoundField HeaderStyle-Width="100px" DataField="EWay_Bill_No" HeaderText="EWayBill No" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="ackno" HeaderText="ACKNo" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="saleid" HeaderText="SaleID" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="IsDeleted" HeaderText="IsDeleted" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="DO_No" HeaderText="DO No" />
                    </Columns>
                </asp:GridView>
                </center>
                <br />
