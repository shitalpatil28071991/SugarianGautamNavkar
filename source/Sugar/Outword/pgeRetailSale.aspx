    ...
    <script type="text/javascript">
        ...
        function pagevalidation() {
            ...
            try {
                ...
                var googlepayac = '<%= Session["googlepayac"] %>';
                var ga = '<%= Session["ga"] %>';
                var phonepay = '<%= Session["phonepayac"] %>';
                var pa = '<%= Session["pa"] %>';
                var googlepayac = '<%= Session["googlepayac"] %>';
                var ga = '<%= Session["ga"] %>';
                var phonepay = '<%= Session["phonepayac"] %>';
                var pa = '<%= Session["pa"] %>';
                var paytype = $("#<%=drpPaytype.ClientID %>").val();
                ...
                XML = XML + "<RetailHead " + DOCNO + " Doc_Date='" + Doc_Date + "' Challan_No='" + Challan_No + "' Challan_Date='" + Challan_Date + "' Vahical_No='" + Vahical_No + "' " +
                    ...
                    "' Transport_Code='" + transportcode + "' tc='" + tc + "' IsDelete='1' TDS_Rate='" + TDS_Rate + "' TDS_Amt='" + TDS_Amt + "' paytype='" + paytype + "'>";
                ...
                for (var i = 1; i < grdrow.length; i++) {
                    ...
                    var googlepaynarration = "Received through google pay";
                    var phonepaynarration = "Received through phone pay";
                ...
                if (NetValue > 0) {
                    ...
                    Order_Code = Order_Code + 1;
                    if (paytype == 'G') {
                        XML = XML + "<Ledger TRAN_TYPE='GP' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + Party_Code + "' " +
                                                                 "UNIT_code='0' NARRATION='" + googlepaynarration + "' AMOUNT='" + NetValue + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                                 "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='C' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                                 "SORT_TYPE='SG' SORT_NO='" + Doc_No + "' ac='" + pc + "' vc='0' progid='116' tranid='0'/>";
                        Order_Code = parseInt(Order_Code) + 1;
                        XML = XML + "<Ledger TRAN_TYPE='GP' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + googlepayac + "' " +
                                                                  "UNIT_code='0' NARRATION='" + googlepaynarration + "' AMOUNT='" + NetValue + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                                  "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                                  "SORT_TYPE='SG' SORT_NO='" + Doc_No + "' ac='" + ga + "' vc='0' progid='116' tranid='0'/>";
                        Order_Code = parseInt(Order_Code) + 1;
                    }

                    if (paytype == 'P') {
                        XML = XML + "<Ledger TRAN_TYPE='GP' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + Party_Code + "' " +
                                                                 "UNIT_code='0' NARRATION='" + phonepaynarration + "' AMOUNT='" + NetValue + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                                 "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='C' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                                 "SORT_TYPE='SG' SORT_NO='" + Doc_No + "' ac='" + pc + "' vc='0' progid='116' tranid='0'/>";
                        Order_Code = parseInt(Order_Code) + 1;
                        XML = XML + "<Ledger TRAN_TYPE='GP' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + phonepay + "' " +
                                                                  "UNIT_code='0' NARRATION='" + phonepaynarration + "' AMOUNT='" + NetValue + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                                  "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                                  "SORT_TYPE='SG' SORT_NO='" + Doc_No + "' ac='" + pa + "' vc='0' progid='116' tranid='0'/>";
                        Order_Code = parseInt(Order_Code) + 1;
                    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hdnfPaytype" runat="server" />
                ...
                <table style="width: 80%;" align="left" cellpadding="4" cellspacing="4">
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:DropDownList runat="server" ID="drpPaytype" Width="100px" CssClass="ddl"
                                AutoPostBack="true" TabIndex="1" OnSelectedIndexChanged="drpPaytype_SelectedIndexChanged">
                                <asp:ListItem Text="No received" Value="N" />
                                <asp:ListItem Text="Phone Pay" Value="P" />
                                <asp:ListItem Text="Google Pay" Value="G" />
                            </asp:DropDownList>
                            Change No
