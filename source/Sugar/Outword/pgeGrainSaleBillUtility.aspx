<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeGrainSaleBillUtility.aspx.cs" Inherits="Sugar_Outword_pgeGrainSaleBillUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Outword/pgeGrainSaleBillUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(2).html($(this).find("Cash_Credit").text());
                    $("td", row).eq(3).html($(this).find("PartyName").text());
                    $("td", row).eq(4).html($(this).find("BrokerName").text());
                    $("td", row).eq(5).html($(this).find("Amount").text());
                    $("td", row).eq(6).html($(this).find("Ack_No").text());
                    $("td", row).eq(7).html($(this).find("EWay_Bill_No").text());
                    $("td", row).eq(8).html($(this).find("Sale_Id").text());
                    $("td", row).eq(9).html($(this).find("IsDelete").text());
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                var Action = 1;
                var Sale_Id = tableData[8];
                var Tran_Type = tableData[2];
                if (row_index > 0) {
                    if (isNaN(Sale_Id)) {
                    }
                    else {
                        window.open('../Outword/pgeGrainSaleBill.aspx?Sale_Id=' + Sale_Id + '&Action=' + Action + '&Cash_Credit=' + Tran_Type);
                    }
                }
            });
    ...
    <script type="text/javascript">
        function saleBill() {
            ...
            window.open("../Outword/pgeGrainSaleBillUtility.aspx", "_self")
            window.open('../Outword/pgeGrainSaleBill.aspx?Sale_Id=' + Sale_Id + '&Action=' + Action + '&Cash_Credit=' + tran_type);
        }
    </script>
    <script type="text/javascript">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Button ID="btnAdd" runat="server" Text="Add New" class="btnHelp" OnClientClick="saleBill()"
                ValidationGroup="save" Width="90px" Height="24px" OnClick="btnAdd_Click" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  
            <asp:Label ID="lblUtilityName" runat="server" Text="Grain Sale Bill" Font-Bold="True"
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="80"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="5px" DataField="Cash_Credit" HeaderText="Cash Credit" />
                        <asp:BoundField HeaderStyle-Width="150px" DataField="PartyName" HeaderText="Party Name" />
                        <asp:BoundField HeaderStyle-Width="150px" DataField="BrokerName" HeaderText="Broker Name" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="Amount" HeaderText="Amount" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="Ack_No" HeaderText="Ack_No" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="EWay_Bill_No" HeaderText="EwayBillNo" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="Sale_Id" HeaderText="Sale_Id" />
