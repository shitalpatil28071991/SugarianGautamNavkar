<%@ Page Title="Unregister Bill Utility" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PgeUnregister_BillUtility.aspx.cs" Inherits="Sugar_Outword_PgeUnregister_BillUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Outword/PgeUnregister_BillUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(2).html($(this).find("Ac_Name").text());
                    $("td", row).eq(3).html($(this).find("Sale_Name").text());
                    $("td", row).eq(4).html($(this).find("amount").text());
                    $("td", row).eq(5).html($(this).find("bill_id").text());
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    if (isNaN(Ac_Code)) {
                        ...
                        window.open('../Outword/PgeUnregister_Bill.aspx?Group_Code=' + Ac_Code + '&Action=' + Action);
                    }
                }
            });
    ...
    <script type="text/javascript">
        function LocalVoucher() {
            ...
            window.open('../Outword/PgeUnregister_Bill.aspx?doc_no=' + Ac_Code + '&Action=' + Action);
        }
    </script>
    <script type="text/javascript">
        function functionToTriggerClick() {
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1600px" Height="60"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="130px" DataField="Ac_Name" HeaderText="Customer Name" />
                        <asp:BoundField HeaderStyle-Width="120px" DataField="Sale_Name" HeaderText="Sale Name" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="amount" HeaderText="Amount" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="bill_id" HeaderText="bill_id" />
