...
public partial class Sugar_Outword_PgeUnregister_BillUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( Ac_Name like '%" + aa + "%' or Sale_Name like '%" + aa + "%' or doc_no like '%" + aa + "%' or doc_dateConverted like '%" + aa + "%' or amount like '%" + aa + "%' ) and";
       ...
       + "Ac_Name ,Sale_Name,amount,bill_id FROM qryOtherInvoice   where " + name + " and Company_Code=" + Company_Code + " " +
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
       ...
       + "Ac_Name ,Sale_Name, amount,bill_id FROM " + qryCommon + " limit 15";
