...
public partial class Sugar_Outword_PgeRetailPurchaseUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, string Trantype, int PageSize, int Company_Code, int year)
    {
      ...
      + "partyname as Party_Name ,Grand_Total,case when Delivered='0' then 'false' else 'true' end as Delivered,retailid FROM qryRetailPurchase   where " + name + " and CashCredit='" + Trantype + "' and Company_Code=" + Company_Code + " " +
