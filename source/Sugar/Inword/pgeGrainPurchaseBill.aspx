<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeGrainPurchaseBill.aspx.cs" Inherits="Sugar_Inword_pgeGrainPurchaseBill" %>
...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function Back() {
            window.open('../Inword/pgeGrainPurchaseBillUtility.aspx', '_self');
        }
    </script>
    <script type="text/javascript" language="javascript">
        debugger;
...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript" language="javascript">
        function DeleteConform() {
            debugger;
            $("#loader").show();
            var DocNo = document.getElementById("<%= hdnfPSdoc.ClientID %>").value;
            var Autoid = document.getElementById("<%= hdnfPS_Id.ClientID %>").value;

            var Branch_Code = '<%= Session["Branch_Code"] %>';
            var Company_Code = '<%= Session["Company_Code"] %>';
            var Year_Code = '<%= Session["year"] %>';

            var XML = "<ROOT><Purchase_Head Doc_No='" + DocNo + "' Sale_Id='" + Autoid + "' Company_Code='" + Company_Code + "' " +
                   "Year_Code='" + Year_Code + "'></Purchase_Head></ROOT>";
        ...
        function pagevalidation() {
            ...
            try {
                $("#loader").show();
                var Doc_No = 0, PS_Id = 0, psdetailid = 0, GId = 0;
                var XML = "<ROOT>";
                var spname = "GrainPurchaseBill";
                var Tran_Type = "PG";
                var CashCredit = $("#<%=drpCashCredit.ClientID %>").val();
                var status = document.getElementById("<%= btnSave.ClientID %>").value;
                if (status == "Update") {
                    Doc_No = document.getElementById("<%= hdnfPSdoc.ClientID %>").value;
                    PS_Id = document.getElementById("<%= hdnfPS_Id.ClientID %>").value;
                }
                ...
                var ac = document.getElementById("<%= hdnfac.ClientID %>").value;
                var bc = 0;
                ...
                XML = XML + "<Purchase_Head Cash_Credit='" + CashCredit + "'" + DOCNO + " Doc_Date='" + Doc_Date + "' Ac_Code='" + Ac_Code + "' Broker='" + Broker + "' LR_No='" + LR_No + "' Truck_No='" + Truck_No + "' " +
                    "Taxable_Amount='" + Taxable_Amount + "' CGST_Amount='" + CGST_Amount + "' SGST_Amount='" + SGST_Amount + "' IGST_Amount='" + IGST_Amount + "' Hamali='" + HamaliAmount + "' " +
                    "postage='" + postage + "' Amount='" + Amount + "' TCS_Par='" + TCS_Par + "' TCS_Amount='" + TCS_Amount + "' Company_Code='" + Company_Code + "' Year_Code='" + Year_Code + "' " +
                    "Created_By='" + USER + "' Modified_By='" + USER + "' Branch_Code='" + Branch_Code + "' " +
                    "PS_Id='" + PS_Id + "' Bill_No='" + Bill_No + "' ac='" + ac + "' bc='" + bc + "' TDS_Rate='" + TDS_Rate + "' TDS_Amt='" + TDS_Amt + "'>";
                ...
                for (var i = 1; i < grdrow.length; i++) {
                    ...
                    var CGST = gridView.rows[i].cells[14].innerHTML;
                    var SGST = gridView.rows[i].cells[15].innerHTML;
                    ...
                    var psdetailid = gridView.rows[i].cells[19].innerHTML;

                    var ic = gridView.rows[i].cells[22].innerHTML;
                    if (gridView.rows[i].cells[20].innerHTML == "A") {

                        XML = XML + "<Purchase_DetailInsert Cash_Credit='" + CashCredit + "' Doc_No='" + Doc_No + "' detail_id='" + ID + "' PS_Id='" + PS_Id + "' Item_Code='" + Item_Code + "' " +
                            "Brand_Code='" + Brand_Code + "' Qty='" + Qty + "' Wt_Per='" + Wt_Per + "' Wt_Qty='" + Wt_Qty + "' Rate='" + Rate + "' " +
                        "Value='" + Value + "' GST_Code='" + GST_Code + "' SGST='" + SGST + "' CGST='" + CGST + "' IGST='" + IGST + "' Hamali_Rate='" + Hamali_Rate + "' Hamali='" + Hamali + "' " +
                         "PSDetail_Id='" + ddid + "' Company_Code='" + Company_Code + "' Year_Code='" + Year_Code + "' Branch_Code='" + Branch_Code + "' " +
                        "Created_By='" + USER + "' Modified_By='" + USER + "' ic='" + ic + "'/>";
                        ddid = parseInt(ddid) + 1;
                    }
                    else if (gridView.rows[i].cells[20].innerHTML == "U") {
                        var Sale_Id = gridView.rows[i].cells[13].innerHTML;
                        XML = XML + "<Purchase_Detail Cash_Credit='" + CashCredit + "' Doc_No='" + Doc_No + "' detail_id='" + ID + "' PS_Id='" + PS_Id + "' Item_Code='" + Item_Code + "' " +
                            "Brand_Code='" + Brand_Code + "' Qty='" + Qty + "' Wt_Per='" + Wt_Per + "' Wt_Qty='" + Wt_Qty + "' Rate='" + Rate + "' " +
                       "Value='" + Value + "' GST_Code='" + GST_Code + "' SGST='" + SGST + "' CGST='" + CGST + "' IGST='" + IGST + "' Hamali_Rate='" + Hamali_Rate + "' Hamali='" + Hamali + "' " +
                       "PSDetail_Id='" + psdetailid + "' Company_Code='" + Company_Code + "' Year_Code='" + Year_Code + "' Branch_Code='" + Branch_Code + "' " +
                       "Created_By='" + USER + "' Modified_By='" + USER + "' ic='" + ic + "'/>";
                    }
                    else if (gridView.rows[i].cells[20].innerHTML == "D") {
                        var Sale_Id = gridView.rows[i].cells[13].innerHTML;
                        XML = XML + "<Purchase_DetailDelete Cash_Credit='" + CashCredit + "' Doc_No='" + Doc_No + "' detail_id='" + ID + "' PS_Id='" + PS_Id + "' Item_Code='" + Item_Code + "' " +
                            "Brand_Code='" + Brand_Code + "' Qty='" + Qty + "' Wt_Per='" + Wt_Per + "' Wt_Qty='" + Wt_Qty + "' Rate='" + Rate + "' " +
                       "Value='" + Value + "' GST_Code='" + GST_Code + "' SGST='" + SGST + "' CGST='" + CGST + "' IGST='" + IGST + "' Hamali_Rate='" + Hamali_Rate + "' Hamali='" + Hamali + "' " +
                      "PSDetail_Id='" + psdetailid + "' Company_Code='" + Company_Code + "' Year_Code='" + Year_Code + "' Branch_Code='" + Branch_Code + "' " +
                       "Created_By='" + USER + "' Modified_By='" + USER + "' ic='" + ic + "'/>";
                ...
                var saleaccountnarration = "" + AcShort_Name + "L:" + LR_No + " " + Qty + "";
                ...
                if (HamaliAmount > 0) {
                    ...
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' Doc_No='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + '<%=Session["Hamali"] %>' + "' " +
                                                            "UNIT_code='0' NARRATION='" + saleaccountnarration + "' AMOUNT='" + HamaliAmount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                            "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                            "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + '<%=Session["Hamaliid"] %>' + "' vc='0' progid='6' tranid='0'/>";
                ...
                if (Amount > 0) {
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + Ac_Code + "' " +
                                                            "UNIT_code='0' NARRATION='" + saleaccountnarration + "' AMOUNT='" + Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                            "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='C' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                            "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + ac + "' vc='0' progid='5' tranid='0'/>";

                    Order_Code = Order_Code + 1;
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + PurchaseAc + "' " +
                                                           "UNIT_code='0' NARRATION='" + saleaccountnarration + "' AMOUNT='" + Taxable_Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                           "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                           "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + PurchaseAcid + "' vc='0' progid='5' tranid='0'/>";
                }
                if (CGST_Amount > 0) {
                    Order_Code = Order_Code + 1;
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + '<%=Session["PurchaseCGSTAc"] %>' + "' " +
                                                      "UNIT_code='0' NARRATION='" + saleaccountnarration + "' AMOUNT='" + CGST_Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                      "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                      "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + '<%=Session["PurchaseCGSTid"] %>' + "' vc='0' progid='5' tranid='0'/>";
                }
                //end CGSTAcc Effect
                //SGSTAcc Effect
                if (SGST_Amount > 0) {
                    Order_Code = Order_Code + 1;
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + '<%=Session["PurchaseSGSTAc"] %>' + "' " +
                                                      "UNIT_code='0' NARRATION='" + saleaccountnarration + "' AMOUNT='" + SGST_Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                      "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                      "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + '<%=Session["PurchaseSGSTid"] %>' + "' vc='0' progid='5' tranid='0'/>";
                }
                //end SGSTAcc Effect
                ...
                if (IGST_Amount > 0) {
                    Order_Code = Order_Code + 1;
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + '<%=Session["PurchaseIGSTAc"] %>' + "' " +
                                                      "UNIT_code='0' NARRATION='" + saleaccountnarration + "' AMOUNT='" + IGST_Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                      "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                      "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + '<%=Session["PurchaseIGSTid"] %>' + "' vc='0' progid='5' tranid='0'/>";
                }
                //end IGSTAcc Effect
                ...
                if (postage != 0) {
                    if (postage > 0) {
                        ...
                        XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' Doc_No='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + '<%=Session["POSTAGE_AC"] %>' + "' " +
                                                          "UNIT_code='0' NARRATION='" + saleaccountnarration + "' AMOUNT='" +Math.abs(postage) + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                        "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                       "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + '<%=Session["POSTAGE_ACid"] %>' + "' vc='0' progid='6' tranid='0' />";
                }
                else {
                    Order_Code = parseInt(Order_Code) + 1;
               ...
               if (TCS_Amount > 0) {
                   ...
                   Order_Code = Order_Code + 1;
                   XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + '<%=Session["PurchaseTCSAc"] %>' + "' " +
                                                      "UNIT_code='0' NARRATION='" + TCSNarration + "' AMOUNT='" + TCS_Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                      "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                      "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + '<%=Session["PurchaseTCSAcid"] %>' + "' vc='0' progid='5' tranid='0'/>";
        }
                if (TDS_Amt > 0) {
                    ...
                    Order_Code = Order_Code + 1;
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + '<%=Session["PurchaseTDSAc"] %>' + "' " +
                                                      "UNIT_code='0' NARRATION='" + TDSNarration + "' AMOUNT='" + TDS_Amt + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                      "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='C' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                      "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + '<%=Session["PurchaseTDSacid"] %>' + "' vc='0' progid='5' tranid='0'/>";
            }


        XML = XML + "</Purchase_Head></ROOT>";
        ProcessXML(XML, status, spname);
...
function ProcessXML(XML, status, spname) {
    ...
    function OnSuccess(response) {
        ...
        if (response.d.length > 0) {
            ...
            CashCredit = $("#<%=drpCashCredit.ClientID %>").val();
                    window.open('../Inword/pgeGrainPurchaseBill.aspx?PS_Id=' + id + '&Action=1&Cash_Credit=' + CashCredit, "_self");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <fieldset style="border-top: 1px dotted rgb(131, 127, 130); border-radius: 3px; width: 90%; margin-left: 30px; float: left; border-bottom: 0px; padding-top: 0px; padding-bottom: 10px; border-left: 0px; border-right: 0px; height: 7px;">
        <legend style="text-align: center;">
            <asp:Label ID="label4" runat="server" Text="   Purchase Bill For GST   " Font-Names="verdana"
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hdnfPSdoc" runat="server" />
            <asp:HiddenField ID="hdnfPS_Id" runat="server" />
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table width="90%" align="left" cellspacing="3">
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="txtTruck_No" runat="Server" CssClass="txt" TabIndex="7" Width="200px"
                            ...
                            Height="24px"></asp:TextBox>
                            Bill No.:
                            <asp:TextBox ID="txtbillNo" runat="Server" CssClass="txt" TabIndex="8" Width="200px"
                ...
                <asp:Panel ID="Panel2" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                    ...
                    <table width="100%" align="center" cellspacing="5">
                        ...
                        <tr>
                            <td align="left">Item:
                                <asp:TextBox ID="txtItem_Code" runat="Server" CssClass="txt" TabIndex="9" Width="80px"
                                ...
                                <asp:TextBox ID="txtBrand_Code" runat="Server" AutoPostBack="false" CssClass="txt"
                                    ...
                                    TabIndex="10" Width="90px" onkeydown="Brand_Code(event);"></asp:TextBox>
                        ...
                        <tr>
                            <td>GST Rate Code:
                                <asp:TextBox ID="txtGST_Code" runat="Server" CssClass="txt" TabIndex="16" Width="80px"
                                    Height="24px" Style="text-align: left;" AutoPostBack="false"
                                    OnTextChanged="txtGST_Code_TextChanged" onKeyDown="GSTRate(event);"></asp:TextBox>
                         ...
                         <asp:TextBox ID="txtIGST" runat="Server" CssClass="txt" Width="80px" AutoPostBack="true"
                             ...
                             Height="24px"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtHamali_Rate" runat="Server" CssClass="txt" TabIndex="20" Width="80px"
                                    Height="24px" Style="text-align: right;" AutoPostBack="True"
                                    ...
                                    <tr>
                                        ...
                                        <td style="">
                                            ...
                                            <asp:TextBox ID="txtTCS_Amount" runat="Server" AutoPostBack="True" CssClass="txt" Height="24px"
                                                TabIndex="52" OnTextChanged="txtTCS_Amount_TextChanged" ReadOnly="false" Style="text-align: right;"
