<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeGrainPurchaseBillUtility.aspx.cs" Inherits="Sugar_Inword_pgeGrainPurchaseBillUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Inword/pgeGrainPurchaseBillUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(1).html($(this).find("Cash_Credit").text());
                    ...
                    $("td", row).eq(6).html($(this).find("PS_Id").text());
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                var Action = 1;
                var Ac_Code = tableData[6];
                var Tran_type = tableData[1];
                if (row_index > 0) {
                    if (isNaN(Ac_Code)) {
                    }
                    else {
                        window.open('../Inword/pgeGrainPurchaseBill.aspx?PS_Id=' + Ac_Code + '&Action=' + Action + '&Cash_Credit=' + Tran_type);
                    }
                }
            });
        ...
        <ContentTemplate>
            ...
            <asp:DropDownList ID="drpTrnType" runat="server" CssClass="ddl" Width="200px" Height="24px"
                AutoPostBack="false" onchange="functionToTriggerClick();">
                  <asp:ListItem Text="Credit" Value="CR" Selected="True"></asp:ListItem>
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
            <asp:Label ID="lblUtilityName" runat="server" Text="Grain Purchase Bill" Font-Bold="True"
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="60"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="100px" DataField="partyname" HeaderText="Party Name" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="brokername" HeaderText="Broker Name" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="Amount" HeaderText="Amount" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="PS_Id" HeaderText="BillId" />
