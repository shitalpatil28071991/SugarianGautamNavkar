<%@ Page Language="C#" Title="U-Purchase Return" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeShugarPurchHeadUtility.aspx.cs" Inherits="Sugar_Master_PgeShugarPurchHeadUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Inword/PgeShugarPurchHeadUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(5).html($(this).find("prid").text());
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#gvCustomers ').on('click', 'tr', function () {
                ...
                var Action = 1;
                var prid = tableData[5];
                if (row_index > 0) {
                    if (isNaN(prid)) {

                    }
                    else {
                        window.open('../Inword/pgeSugarPurchaseReturnForGST.aspx?prid=' + prid + '&Action=' + Action);
                    }
                }
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Button ID="btnAdd" runat="server" Text="Add New" class="btnHelp" OnClientClick="SugarPurchase()"
                ValidationGroup="save" Width="90px" Height="24px" OnClick="btnAdd_Click" />
             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  
            <asp:Label ID="lblUtilityName" runat="server" Text="Sugar Sale Return Purchase" Font-Bold="True"
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="60"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="20px" DataField="prid" HeaderText="PurchID" />
