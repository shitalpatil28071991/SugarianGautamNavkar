...
public partial class Sugar_Master_PgeShugarPurchHeadUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( Ac_Name_E like '%" + aa + "%' or doc_no like '%" + aa + "%' or NETQNTL like '%" + aa + "%' or Bill_Amount like '%" + aa + "%' or prid like '%" + aa + "%' or doc_dateConverted like '%" + aa + "%' ) and";
       ...
       + "Ac_Name_E ,NETQNTL,Bill_Amount,prid,ackno FROM qrysugarpurchasereturnhead   where " + name + " and Company_Code=" + Company_Code + " " +
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        qry = " select doc_no,doc_dateConverted as doc_date,Ac_Name_E ,NETQNTL,Bill_Amount,prid FROM " + qryCommon + " limit 15";
