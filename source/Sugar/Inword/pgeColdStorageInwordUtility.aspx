<%@ Page Title="U-Cold Storage Inword" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeColdStorageInwordUtility.aspx.cs" Inherits="Sugar_Inword_pgeColdStorageInwordUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Inword/pgeColdStorageInwordUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                ...
                $.each(customers, function () {
                    ...
                    $("td", row).eq(2).html($(this).find("Ac_Code").text());
                    $("td", row).eq(3).html($(this).find("Ac_Name_E").text());
                    $("td", row).eq(4).html($(this).find("Item_Code").text());
                    $("td", row).eq(5).html($(this).find("Brand_Code").text());
                    $("td", row).eq(6).html($(this).find("No_Of_Bags").text());
                    $("td", row).eq(7).html($(this).find("Wt_Per").text());
                    $("td", row).eq(8).html($(this).find("csid").text());
    ...
    <script type="text/javascript">
        function Citymaster() {
            ...
            window.open('../Inword/pgeColdStorageInword.aspx?Doc_No=' + Doc_No + '&Action=' + Action);
        }
            ...
            $('#gvCustomers').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    ...
                    if (isNaN(Doc_No)) {
                        ...
                        window.open('../Inword/pgeColdStorageInword.aspx?csid=' + Doc_No + '&Action=' + Action);
                    }
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="Auto">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;   
                 <asp:Label ID="lblUtilityName" runat="server" Text="Cold Storage Inword" Font-Bold="True"
               ...
               ForeColor="#CC3300" Font-Size="Medium"></asp:Label>
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="60"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="70px" DataField="Doc_Date" HeaderText="Date" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="Ac_Code" HeaderText="Ac Code" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="Ac_Name_E" HeaderText="Ac Name" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="Item_Code" HeaderText="Item Code" />
                        <asp:BoundField HeaderStyle-Width="250px" DataField="Brand_Code" HeaderText="Brand Code" />
                        <asp:BoundField HeaderStyle-Width="70px" DataField="No_Of_Bags" HeaderText="Qty" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="70px" DataField="Wt_Per" HeaderText="Wt/Per" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="csid" HeaderText="csid" />
