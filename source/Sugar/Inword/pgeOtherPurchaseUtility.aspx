<%@ Page Title="U-Other Purchase" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeOtherPurchaseUtility.aspx.cs" Inherits="Sugar_Inword_pgeOtherPurchaseUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Inword/pgeOtherPurchaseUtility.aspx/GetCustomers",//change page name
                data: '{searchTerm: "' + SearchTerm() + '", pageIndex: "' + pageIndex + '",PageSize: "' + $("#<%=drpPagesize.ClientID %>").val() + '",Company_Code: "' + '<%= Session["Company_Code"] %>' + '",Year_Code: "' + '<%= Session["year"] %>' + '"}',
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    var customer = $(this);
                    $("td", row).eq(0).html($(this).find("Doc_No").text());//db name
                    $("td", row).eq(1).html($(this).find("Doc_Date").text());
                    $("td", row).eq(2).html($(this).find("suppilername").text());
                    $("td", row).eq(3).html($(this).find("Bill_Amount").text());
                    $("td", row).eq(4).html($(this).find("Narration").text());
                    $("td", row).eq(5).html($(this).find("opid").text());
    ...
    <script type="text/javascript">
        function Citymaster() {
            var Action = 2;
            var Doc_No = 0;//variable name change
            window.open("../Inword/pgeOtherPurchaseUtility.aspx", "_self")
            window.open('../Inword/pgeOther_Purchase.aspx?Doc_No=' + Doc_No + '&Action=' + Action);//main page name(master page la utility page name dene)
        }
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#gvCustomers').on('dblclick', 'tr', function () {
                ...
                var Action = 1;
                var Doc_No = tableData[5];//id cha count
                ...
                if (row_index > 0) {
                    ...
                    if (isNaN(Doc_No)) {//
                        ...
                        window.open('../Inword/pgeOther_Purchase.aspx?opid=' + Doc_No + '&Action=' + Action);//page name
                    }
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                 <asp:Label ID="lblUtilityName" runat="server" Text="Other Purchase" Font-Bold="True"
           ...
           <asp:Label ID="Label3" runat="server" Text="Search:" Font-Bold="True"
               ForeColor="#CC3300" Font-Size="Medium"></asp:Label>
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="60"
                    ...
                    <Columns>
                        <asp:BoundField HeaderStyle-Width="20px" DataField="Doc_No" HeaderText="Entry No " />
                        <asp:BoundField HeaderStyle-Width="150px" DataField="Doc_Date" HeaderText="Doc_Date" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="suppilername" HeaderText="Suppiler Name" />
                        ...
                        <asp:BoundField HeaderStyle-Width="50px" DataField="opid" HeaderText="OPid" />
