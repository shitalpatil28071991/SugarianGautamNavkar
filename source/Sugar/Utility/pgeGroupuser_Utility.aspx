<%@ Page Title="U-Gropu User" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeGroupuser_Utility.aspx.cs" Inherits="Sugar_Utility_pgeGroupuser_Utility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Utility/pgeGroupuser_Utility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(1).html($(this).find("Group_Code").text());
                    $("td", row).eq(2).html($(this).find("Group_Name").text());
                    $("td", row).eq(3).html($(this).find("Login_Name").text());
                    $("td", row).eq(4).html($(this).find("UserType").text());
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                var Action = 1;
                var Ac_Code = tableData[0];

                if (row_index > 0) {
                    if (isNaN(Ac_Code)) {
                    }
                    else {
                        window.open('../Utility/pgeGroupuser.aspx?Doc_No=' + Ac_Code + '&Action=' + Action);
                    }
                }
            });
               ...
               ForeColor="#CC3300" Font-Size="Medium"></asp:Label>
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="60"
                    ...
                    <Columns>
                         ...
                         <asp:BoundField HeaderStyle-Width="10px" DataField="Doc_No" HeaderText="Doc No" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="Group_Code" HeaderText="Group Code" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="Group_Name" HeaderText="Group Name" />
                        <asp:BoundField HeaderStyle-Width="5px" DataField="Login_Name" HeaderText="Login Name" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="UserType" HeaderText="User Type" />
