<%@ Page Title="U-User Creation" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeUserCreation_Utility.aspx.cs" Inherits="Sugar_Utility_pgeUserCreation_Utility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
      ...
      function GetCustomers(pageIndex) {
          ...
          $.ajax({
              type: "POST",
              url: "../Utility/pgeUserCreation_Utility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    var customer = $(this);
                    $("td", row).eq(0).html($(this).find("User_Id").text());
                    $("td", row).eq(1).html($(this).find("userfullname").text());
                    $("td", row).eq(2).html($(this).find("User_Type").text());
                    $("td", row).eq(3).html($(this).find("EmailId").text());
                    $("td", row).eq(4).html($(this).find("Mobile").text());
                    $("td", row).eq(5).html($(this).find("uid").text());
    ...
    <script type="text/javascript">
        function Citymaster() {
            ...
            window.open('../Utility/pgeUser_Creation.aspx?User_Id=' + UserId + '&Action=' + Action);
        }
            ...
            $('#gvCustomers').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    ...
                    if (isNaN(UserId)) {
                        ...
                        window.open('../Utility/pgeUser_Creation.aspx?uid=' + UserId + '&Action=' + Action);
                    }
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   
                 <asp:Label ID="lblUtilityName" runat="server" Text="User Creation" Font-Bold="True"
               ...
               ForeColor="#CC3300" Font-Size="Medium"></asp:Label>
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="60"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="10px" DataField="User_Id" HeaderText="User Id" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="userfullname" HeaderText="User Full Name" />
                        <asp:BoundField HeaderStyle-Width="5px" DataField="User_Type" HeaderText="User Type" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="EmailId" HeaderText="EmailId" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="Mobile" HeaderText="Mobile No" />
                        <asp:BoundField HeaderStyle-Width="5px" DataField="uid" HeaderText="Uid" />
