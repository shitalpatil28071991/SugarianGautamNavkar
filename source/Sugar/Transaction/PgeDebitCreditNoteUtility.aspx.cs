...
public partial class Sugar_Master_PgeDebitCreditNoteUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, string Trantype, int PageSize, int Company_Code, int year)
    {
     ...
     + "doc_dateConverted as doc_date ,Ac_Name_E,bill_amount,dcid,ShopTo_Name,bill_id,ackno,IsDeleted FROM qrydebitnotehead    where " + name + " and tran_type='" + Trantype + "' and Company_Code=" + Company_Code + " " +
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
     ...
     + "doc_dateConverted as doc_date ,Ac_Name_E,bill_amount,dcid,ShopTo_Name,bill_id,ackno,IsDeleted FROM " + qryCommon + " limit 15";
