    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "../Transaction/PgeDebitCreditNoteUtility.aspx/GetCustomers",
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    if (isNaN(Ac_Code)) {
                        ...
                        window.open('../Transaction/pgeDebitCreditNote.aspx?dcid=' + Ac_Code + '&Action=' + Action + '&tran_type=' + Tran_Type);
                    }
                }
            });
