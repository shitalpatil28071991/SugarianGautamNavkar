...
public partial class Sugar_Transaction_pgeTransactionUtility : System.Web.UI.Page
{
    ...
    {
        qryCommon = "qrytransactionheaddetail";
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( debitname like '%" + aa + "%' or narration like '%" + aa + "%' or doc_dateConverted like '%" + aa + "%' or doc_dateConverted like '%" + aa + "%' or amount like '%" + aa + "%' or tranid like '%" + aa + "%' ) and";
       ...
       + "debitname as Ac_Name_E ,amount,narration,tranid FROM qrytransactionheaddetail   where " + name + " and tran_type='JV' and Company_Code=" + Company_Code + " " +
