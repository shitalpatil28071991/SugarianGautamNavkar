<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TransactionEntryUtility.aspx.cs" Inherits="Sugar_Transaction_TransactionEntryUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Transaction/TransactionEntryUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(2).html($(this).find("Account_Name").text());
                    $("td", row).eq(3).html($(this).find("Name").text());
                    $("td", row).eq(4).html($(this).find("Amount").text());
                    $("td", row).eq(5).html($(this).find("UTRNumber").text());
                    $("td", row).eq(6).html($(this).find("Id").text());
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#gvCustomers ').on('click', 'tr', function () {
                ...
                if (row_index > 0) {
                    window.open('../Transaction/pgeTransactionEntry.aspx?id=' + Ac_Code + '&Action=' + Action);
                }
            });
    ...
    <script type="text/javascript">
        function UTR() {
            ...
            window.open('../Transaction/pgeTransactionEntry.aspx?doc_no=' + Ac_Code + '&Action=' + Action);
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;     
            <asp:Label ID="lblUtilityName" runat="server" Text="Bank Transaction" Font-Bold="True"
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px" Height="80" OnRowDataBound="gvCustomers_RowDataBound"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="20px" DataField="doc_dateConverted" HeaderText="Doc Date" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="Account_Name" HeaderText="Account Name" />
                        <asp:BoundField HeaderStyle-Width="100px" DataField="Name" HeaderText="Name" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="Amount" HeaderText="Amount" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="UTRNumber" HeaderText="UTR No" /> 
                        <asp:BoundField HeaderStyle-Width="20px" DataField="Id" HeaderText="ID" /> 
