...
public partial class Sugar_Transaction_pgePaymentNote_Utility : System.Web.UI.Page
{
    ...
    private void BindDummyRow()
    {
        ...
        dummy.Columns.Add("bank_ac");
        dummy.Columns.Add("payment_to");
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( doc_date like '%" + aa + "%' or doc_no like '%" + aa + "%' or bank_ac like '%" + aa + "%' or payment_to like '%" + aa + "%' or pid like '%" + aa + "%' or amount like '%" + aa + "%' or narration like '%" + aa + "%') and";
       ...
       + "bank_ac ,payment_to,amount,narration,pid FROM qryPaymentNote where " + name + " and Company_Code=" + Company_Code + " " +
