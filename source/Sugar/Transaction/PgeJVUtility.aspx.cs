...
public partial class Sugar_Master_PgeJVUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
       ...
       + "debitname as Ac_Name_E ,amount,narration,tranid FROM qrytransheaddetail   where " + name + " and tran_type='JV' and Company_Code=" + Company_Code + " " +
