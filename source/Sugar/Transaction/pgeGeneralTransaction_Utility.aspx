<%@ Page Title="General Transaction Utility" Language="C#" MasterPageFile="~/MasterPage.master" 
    AutoEventWireup="true" CodeFile="pgeGeneralTransaction_Utility.aspx.cs" 
    Inherits="Sugar_Transaction_pgeGeneralTransaction_Utility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Transaction/pgeGeneralTransaction_Utility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(2).html($(this).find("Company_Name_E").text());
                    $("td", row).eq(3).html($(this).find("year").text());
                    $("td", row).eq(4).html($(this).find("DebitAc_Name").text());
                    $("td", row).eq(5).html($(this).find("CreditAc_NAme").text());
                    $("td", row).eq(6).html($(this).find("amount").text());
                    $("td", row).eq(7).html($(this).find("narration").text());
                    $("td", row).eq(8).html($(this).find("gtranid").text());
                ...
                $(".DebitAc_Name").each(function () {
                    var searchPattern = new RegExp('(' + SearchTerm() + ')', 'ig');
                    $(this).html($(this).text().replace(searchPattern, "<span class = 'highlight'>" + SearchTerm() + "</span>"));
                });

                $(".CreditAc_NAme").each(function () {
                    var searchPattern = new RegExp('(' + SearchTerm() + ')', 'ig');
                    $(this).html($(this).text().replace(searchPattern, "<span class = 'highlight'>" + SearchTerm() + "</span>"));
                });
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    if (isNaN(Ac_Code)) {
                        ...
                        window.open('../Transaction/pgeGeneralTransaction.aspx?gtranid=' + Ac_Code + '&Action=' + Action);
                    }
                }
            });
    ...
    <script type="text/javascript">
        function LocalVoucher() {
            ...
            window.open('../Transaction/pgeGeneralTransaction.aspx?doc_no=' + Ac_Code + '&Action=' + Action);
        }
    </script>
    <script type="text/javascript">
        function functionToTriggerClick() {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;   
            <asp:Label ID="lblUtilityName" runat="server" Text="Unregister Bill" Font-Bold="True"
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1600px" Height="60"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="120px" DataField="Company_Name_E" HeaderText="Company Name" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="year" HeaderText="Year" />
                        <asp:BoundField HeaderStyle-Width="130px" DataField="DebitAc_Name" HeaderText="Debit Ac Name" />
                        <asp:BoundField HeaderStyle-Width="130px" DataField="CreditAc_NAme" HeaderText="Credit Ac Name" />
                         <asp:BoundField HeaderStyle-Width="50px" DataField="amount" HeaderText="Amount" />
                         <asp:BoundField HeaderStyle-Width="130px" DataField="narration" HeaderText="narration" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="gtranid" HeaderText="gtranid" />
