<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeReceipt_Data.aspx.cs" Inherits="Sugar_Transaction_pgeReceipt_Data" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Receipt() {
            var Action = 2;
            var Receipt = 0;
            var tran_type = document.getElementById("<%= drpTrnType.ClientID %>").value;
            window.open('../Transaction/pgeReceiptPaymentxml.aspx?Receipt=' + Receipt + '&Action=' + Action + '&tran_type=' + tran_type);
        }
                ...
                <table style="width: 60%;" align="center" cellpadding="4" cellspacing="4" class="bottom-two">
                    <tr>
                        <td>
                            ...
                            &nbsp; &nbsp;
                            <asp:Button ID="btnAdd" runat="server" Text="Add New" class="btnHelp" OnClientClick="Receipt()"
                                TabIndex="2" ValidationGroup="save" Width="90px" Height="24px" />

                        </td>
                        <td>
                            <asp:Button ID="btnPrintGroup_Master" runat="server" Text="Group Master Print" class="btnHelp" OnClientClick="groupmasterPrint()"
                                TabIndex="3" ValidationGroup="save" Height="24px" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
            ...
            <table id="datatable" class="table table-striped table-bordered table-sm ">
                <thead>
                    <tr>
                        ...
                        <td class="danger">cash Bank
                        </td>
                        <td class="danger">tran type
                        </td>
                        <td class="danger">Doc Date
                        </td>
                        <td class="danger">Receipt ID
                        </td>
