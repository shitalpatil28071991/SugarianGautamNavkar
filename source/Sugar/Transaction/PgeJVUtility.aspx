<%@ Page Language="C#" Title="U-Journal Voucher" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeJVUtility.aspx.cs" Inherits="Sugar_Master_PgeJVUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Transaction/PgeJVUtility.aspx/GetCustomers",
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    ...
                    if (isNaN(Ac_Code)) {
                        ...
                        window.open('../Transaction/pgeJournal_Voucher.aspx?tranid=' + Ac_Code + '&Action=' + Action);
                    }
                }
            });
    ...
    <script type="text/javascript">
        function JV() {
            ...
            window.open('../Transaction/pgeJournal_Voucher.aspx?doc_no=' + Ac_Code + '&Action=' + Action);
        }
    </script>
    <script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   
                 <asp:Label ID="lblUtilityName" runat="server" Text="Journal Voucher" Font-Bold="True"
