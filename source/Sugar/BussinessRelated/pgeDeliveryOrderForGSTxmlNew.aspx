...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            if ((txtexcise_rate == "") || txtexcise_rate == "0" || txtexcise_rate == "0.00") {
    ...
    "'  TDSAmount='" + LV_TDSAmt + "'  TDS='" + LV_TDSRate + "' ta='" + CommTDSAc_ID + "' HSN='" + hsnnumber + "'/>";
            ...
            igstrate = '<%= Session["igstrate"] %>';
                ...
                var TDSAmt = document.getElementById("<%= hdnfTDSValue.ClientID %>").value;//Math.round(parseFloat(TaxableAmountForSB) * SaleTDSrate / 100);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hdnfTDSValue" runat="server" />
            <asp:HiddenField ID="hdnfTCSValue" runat="server" />
            <div>
