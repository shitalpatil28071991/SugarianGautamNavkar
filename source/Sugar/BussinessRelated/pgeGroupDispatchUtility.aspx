<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeGroupDispatchUtility.aspx.cs" Inherits="Sugar_BussinessRelated_pgeGroupDispatchUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title> Group Dispatch Utility </title>
    <style type="text/css">
        body
        {
            font-family: Arial;
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../BussinessRelated/pgeGroupDispatchUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(1).html($(this).find("doc_dateConverted").text());
                    $("td", row).eq(2).html($(this).find("purchaseCode").text());
                    $("td", row).eq(3).html($(this).find("purchaseNmber").text());
                    $("td", row).eq(4).html($(this).find("MillShort_Name").text());
                    $("td", row).eq(5).html($(this).find("SBShort_Name").text());
                    $("td", row).eq(6).html($(this).find("quantal").text());
                    $("td", row).eq(7).html($(this).find("millRate").text());
                    $("td", row).eq(8).html($(this).find("saleRate").text());
                    $("td", row).eq(9).html($(this).find("dispatchId").text());
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    if (isNaN(Ac_Code)) {
                        ...
                        window.open('../BussinessRelated/pgeGroupDispatch.aspx?dispatchId=' + Ac_Code + '&Action=' + Action);
                    }
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;    
             <asp:Label ID="lblUtilityName" runat="server" Text="Group Dispatch Utility" Font-Bold="True"
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1700px" Height="80"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="20px" DataField="doc_dateConverted" HeaderText="Date" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="purchaseCode" HeaderText="Tender No " />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="purchaseNmber" HeaderText="T.Detail Id" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="MillShort_Name" HeaderText="Mill Short Name" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="SBShort_Name" HeaderText="SBShort Name" />  
                        <asp:BoundField HeaderStyle-Width="10px" DataField="quantal" HeaderText="Quantal" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="millRate" HeaderText="Mill Rate" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="saleRate" HeaderText="Sale Rate" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="dispatchId" HeaderText="Dispatch Id" />
                    </Columns>
                </asp:GridView>
                </center>
                <br />
