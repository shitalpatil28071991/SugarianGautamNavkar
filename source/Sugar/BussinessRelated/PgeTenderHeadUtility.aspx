        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(6).html($(this).find("paymenttoname").text());
                    $("td", row).eq(7).html($(this).find("tenderdoname").text());
                    $("td", row).eq(8).html($(this).find("season").text());
                    $("td", row).eq(9).html($(this).find("brokershortname").text());
                    $("td", row).eq(10).html($(this).find("Lifting_Date").text());
                    $("td", row).eq(11).html($(this).find("tenderid").text());
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1700px" Height="80"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="10px" DataField="paymenttoname" HeaderText="Payment To" />
                        ...
                        <asp:BoundField HeaderStyle-Width="50px" DataField="brokershortname" HeaderText="Broker Short Name" />
